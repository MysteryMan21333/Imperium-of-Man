...
/datum/component/sizzle/proc/setup_sizzle()
	...
	grill_marks.Blend(icon('modular_imperium/master_files/icons/obj/kitchen.dmi', "grillmarks"), ICON_MULTIPLY) //adds grill marks and the remaining white areas become transparent
