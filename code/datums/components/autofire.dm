...
/datum/component/automatedfire/autofire/Initialize(_auto_fire_shot_delay = 0.3 SECONDS, _auto_burst_fire_shot_delay, _burstfire_shot_delay, _burst_shots_to_fire = 3, _fire_mode = GUN_FIREMODE_SEMIAUTO, datum/callback/_callback_bursting, datum/callback/_callback_reset_fire, datum/callback/_callback_fire)
	...
	RegisterSignals(parent, list(COMSIG_GUN_AUTOFIREDELAY_MODIFIED, COMSIG_TYRANID_AUTOFIREDELAY_MODIFIED), PROC_REF(modify_fire_shot_delay))
	...
	RegisterSignals(parent, list(COMSIG_GUN_FIRE, COMSIG_TYRANID_FIRE, COMSIG_MECH_FIRE, COMSIG_ARMORED_FIRE), PROC_REF(initiate_shot))
	RegisterSignals(parent, list(COMSIG_GUN_STOP_FIRE, COMSIG_TYRANID_STOP_FIRE, COMSIG_MECH_STOP_FIRE, COMSIG_ARMORED_STOP_FIRE), PROC_REF(stop_firing))
