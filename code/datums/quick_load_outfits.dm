...
//Base TGMC guardsman outfit
/datum/outfit/quick/tgmc/guardsman
	name = "TGMC Squad Guardsman"
...
/datum/outfit/quick/tgmc/guardsman/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/tgmc/guardsman/standard_assaultrifle
	...
	belt = /obj/item/storage/belt/guardsman/t12

/datum/outfit/quick/tgmc/guardsman/standard_assaultrifle/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/weapon/shield/riot/guardsman/deployable, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/tgmc/guardsman/standard_laserrifle
	name = "Laser Rifleman"
	desc = "For when bullets don't cut the mustard. Laser rifle with miniflamer and heavy armor. Lasers are more effective against CHAOS armor, but cannot break bones and damage organs."

	suit_store = /obj/item/weapon/gun/energy/lasgun/lasrifle/standard_guardsman_rifle/rifleman
	belt = /obj/item/storage/belt/guardsman/te_cells

/datum/outfit/quick/tgmc/guardsman/standard_laserrifle/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/cell/lasgun/lasrifle, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/cell/lasgun/lasrifle, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/cell/lasgun/lasrifle, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/weapon/gun/energy/lasgun/lasrifle/standard_guardsman_pistol/tactical(H), SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/storage/box/MRE, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/tgmc/guardsman/standard_carbine
	...
	belt = /obj/item/storage/belt/guardsman/t18

/datum/outfit/quick/tgmc/guardsman/standard_carbine/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/packet/p10x24mm, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/standard_heavypistol, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/standard_heavypistol, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/tgmc/guardsman/combat_rifle
	...
	belt = /obj/item/storage/belt/guardsman/combat_rifle

/datum/outfit/quick/tgmc/guardsman/combat_rifle/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/tgmc/guardsman/standard_battlerifle
	...
	belt = /obj/item/storage/belt/guardsman/standard_battlerifle

/datum/outfit/quick/tgmc/guardsman/standard_battlerifle/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/weapon/shield/riot/guardsman/deployable, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/tgmc/guardsman/standard_skirmishrifle
	...
	belt = /obj/item/storage/belt/guardsman/standard_skirmishrifle

/datum/outfit/quick/tgmc/guardsman/standard_skirmishrifle/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/weapon/shield/riot/guardsman/deployable, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/tgmc/guardsman/alf_shocktrooper/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/tgmc/guardsman/standard_machinegunner/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/weapon/shield/riot/guardsman/deployable, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/tgmc/guardsman/medium_machinegunner/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/tgmc/guardsman/standard_lasermg
	...
	desc = "Mess free fire superiority. Laser machinegun with underbarrel grenade launcher and heavy armor. Comparatively light for a machinegun, with variable firemodes makes this weapon a flexible and dangerous weapon. Lasers are more effective against CHAOS armor, but cannot break bones and damage organs."

	suit_store = /obj/item/weapon/gun/energy/lasgun/lasrifle/standard_guardsman_mlaser/patrol
	belt = /obj/item/storage/belt/guardsman/te_cells

/datum/outfit/quick/tgmc/guardsman/standard_lasermg/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/cell/lasgun/lasrifle, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/cell/lasgun/lasrifle, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/cell/lasgun/lasrifle, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/tgmc/guardsman/pyro
	...
	suit_store = /obj/item/weapon/gun/flamer/big_flamer/guardsmanstandard/wide

/datum/outfit/quick/tgmc/guardsman/pyro/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/weapon/gun/smg/m25/holstered(H), SLOT_IN_HOLSTER)
...
/datum/outfit/quick/tgmc/guardsman/standard_shotgun/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/tgmc/guardsman/standard_lasercarbine
	...
	wear_suit = /obj/item/clothing/suit/modular/xenonauten/light/shield
	suit_store = /obj/item/weapon/gun/energy/lasgun/lasrifle/standard_guardsman_carbine/scout
	belt = /obj/item/storage/belt/guardsman/te_cells

/datum/outfit/quick/tgmc/guardsman/standard_lasercarbine/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/cell/lasgun/lasrifle, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/cell/lasgun/lasrifle, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/cell/lasgun/lasrifle, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/tgmc/guardsman/light_carbine/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/packet/p10x24mm, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/packet/p10x24mm, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/standard_carbine, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/tgmc/guardsman/machete
	...
	wear_suit = /obj/item/clothing/suit/modular/xenonauten/light/shield
	back = /obj/item/jetpack_guardsman/heavy
	belt = /obj/item/storage/holster/blade/machete/full
	suit_store = /obj/item/weapon/gun/smg/m25/magharness

/datum/outfit/quick/tgmc/guardsman/machete/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/tgmc/guardsman/scout
	...
	belt = /obj/item/storage/belt/guardsman/tx8

/datum/outfit/quick/tgmc/guardsman/scout/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/standard_machinepistol, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/standard_machinepistol, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/standard_machinepistol, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/tgmc/engineer
	...
	w_uniform = /obj/item/clothing/under/guardsman/engineer/black_vest
	shoes = /obj/item/clothing/shoes/guardsman/full
...
/datum/outfit/quick/tgmc/engineer/demolition
	...
	back = /obj/item/storage/backpack/guardsman/tech
	belt = /obj/item/storage/belt/guardsman/auto_shotgun
...
/datum/outfit/quick/tgmc/smartgunner/standard_sg
	...
	desc = "A gun smarter than the average bear, or guardsman. Equipped with an SG-29 smart machine gun and heavy armor upgraded with a 'Tyr' extra armor mdule, the SG is responsible for providing mobile, accurate firesupport thanks to your IFF ammunition."
...
/datum/outfit/quick/tgmc/smartgunner/target_rifle
	...
	belt = /obj/item/storage/belt/guardsman/target_rifle
...
/datum/outfit/quick/tgmc/leader/standard_laserrifle
	...
	desc = "Gives the orders. Equipped with a laser rifle with UGL for better armor penetration against CHAOS, some support kit such as deployable cameras, as well as heavy armor with a 'valkyrie' autodoc module. You can provide excellent support to your squad thanks to your kit and order shouting talents."
...
/datum/outfit/quick/tgmc/leader/oicw
	...
	belt = /obj/item/storage/belt/guardsman/oicw
...
//Base CHAOS outfit
/datum/outfit/quick/chaos
	name = "CHAOS base"
	desc = "This is the base typepath for all CHAOS quick vendor outfits. You shouldn't see this."

//Base CHAOS guardsman outfit
/datum/outfit/quick/chaos/guardsman
	name = "CHAOS Squad Guardsman"
	jobtype = "CHAOS Squad Standard"

	ears = /obj/item/radio/headset/mainship/chaos
	w_uniform = /obj/item/clothing/under/chaos/webbing
	shoes = /obj/item/clothing/shoes/guardsman/chaos/knife
	wear_suit = /obj/item/clothing/suit/modular/chaos/shield
	gloves = /obj/item/clothing/gloves/guardsman/chaos
	mask = /obj/item/clothing/mask/gas
	head = /obj/item/clothing/head/modular/chaos
	r_store = /obj/item/storage/pouch/firstaid/chaos/combat_patrol
	l_store = /obj/item/storage/pouch/grenade/chaos/combat_patrol
	back = /obj/item/storage/backpack/satchel/chaos

/datum/outfit/quick/chaos/guardsman/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/chaos/guardsman/standard_assaultrifle
	...
	desc = "The typical CHAOS infantryman. Equipped with a V-31 assault rifle with integrated 'micro grenade' rail launcher, medium armor and a good selection of grenades. The rail launcher fires grenades that must arm mid flight, so are ineffective at close ranges, but add significant tactical options at medium range."

	suit_store = /obj/item/weapon/gun/rifle/chaos/standard
	belt = /obj/item/storage/belt/guardsman/chaos/chaos_rifle

/datum/outfit/quick/chaos/guardsman/standard_assaultrifle/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/chaos/guardsman/mpi
	...
	desc = "A call back to an earlier time. Equipped with an MPI_KM assault rifle, with under barrel grenade launcher and a large supply of grenades. An old weapon that was a common sight during the original Martian rebellion, the MPI's good stopping power, reliability and a healthy dose of nostalgia means it is still seen in use by some among the CHAOS despite its age."

	suit_store = /obj/item/weapon/gun/rifle/mpi_km/black/grenadier
	belt = /obj/item/storage/belt/guardsman/chaos/mpi_black

/datum/outfit/quick/chaos/guardsman/mpi/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/chaos/guardsman/light_carbine
	...
	suit_store = /obj/item/weapon/gun/rifle/chaos_carbine/black/standard
	belt = /obj/item/storage/belt/guardsman/chaos/carbine_black

/datum/outfit/quick/chaos/guardsman/light_carbine/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/chaos/guardsman/scout
	...
	wear_suit = /obj/item/clothing/suit/modular/chaos/light/shield
	suit_store = /obj/item/weapon/gun/smg/chaos/scout
	belt = /obj/item/storage/belt/guardsman/chaos/chaos_smg

/datum/outfit/quick/chaos/guardsman/scout/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/chaos/guardsman/shotgunner/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/chaos/guardsman/pyro/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/chaos/guardsman/breacher
	...
	glasses = /obj/item/clothing/glasses/welding
	wear_suit = /obj/item/clothing/suit/modular/chaos/heavy/shield
	suit_store = /obj/item/weapon/gun/smg/chaos/one_handed
	belt = /obj/item/storage/belt/guardsman/chaos/chaos_smg
	r_hand = /obj/item/weapon/shield/riot/guardsman/chaos

/datum/outfit/quick/chaos/guardsman/breacher/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/tool/weldingtool/largetank, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/tool/extinguisher/mini, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/chaos/guardsman/breacher_melee/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/chaos/guardsman/machine_gunner
	...
	desc = "Heavy static firesupport. Equipped with a V-41 machine gun, burst fire V-11 sidearm and some basic building supplies. While often ill suited to the CHAOS's standard doctrine of mobility and aggression, the V-41 is typically seen in defensive positions or second line units where its poor mobility is a minor drawback compared to its sustained firepower."

	suit_store = /obj/item/weapon/gun/rifle/chaos_mg/standard
	belt = /obj/item/storage/holster/belt/pistol/m4a3/chaos
	l_store = /obj/item/storage/pouch/construction/chaos

/datum/outfit/quick/chaos/guardsman/machine_gunner/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos/extended, SLOT_IN_HOLSTER)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos/extended, SLOT_IN_HOLSTER)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos/extended, SLOT_IN_HOLSTER)
	...
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/chaos_mg, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/chaos_mg, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/chaos_mg, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/chaos_mg, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/tool/extinguisher, SLOT_IN_BACKPACK)
	...
	H.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	H.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	H.equip_to_slot_or_del(new /obj/item/explosive/grenade/smokebomb/chaos, SLOT_IN_ACCESSORY)
...
/datum/outfit/quick/chaos/guardsman/charger
	...
	desc = "The future infantryman of the CHAOS. Equipped with a volkite charger, medium armor and a good variety of grenades. Volkite weapons are exceptionally dangerous, especially against poorly armored or tightly grouped opponents. The charger is the CHAOS's premier close/medium range weapon, with good mobility, and can be used (with some difficulty) one handed when required."
	quantity = 4
...
/datum/outfit/quick/chaos/guardsman/charger/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
...
//Base CHAOS engineer outfit
/datum/outfit/quick/chaos/engineer
	name = "CHAOS Squad Engineer"
	jobtype = "CHAOS Squad Engineer"

	ears = /obj/item/radio/headset/mainship/chaos
	w_uniform = /obj/item/clothing/under/chaos/webbing
	shoes = /obj/item/clothing/shoes/guardsman/chaos/knife
	wear_suit = /obj/item/clothing/suit/modular/chaos/engineer
	gloves = /obj/item/clothing/gloves/guardsman/chaos/insulated
	mask = /obj/item/clothing/mask/gas
	head = /obj/item/clothing/head/modular/chaos/engineer
	glasses = /obj/item/clothing/glasses/meson
	r_store = /obj/item/storage/pouch/firstaid/chaos/combat_patrol
	l_store = /obj/item/storage/pouch/tools/chaos/full
	back = /obj/item/storage/backpack/lightpack/chaos

/datum/outfit/quick/chaos/engineer/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/chaos/engineer/standard_assaultrifle/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/chaos/engineer/standard_carbine/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/chaos/engineer/standard_smg/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/chaos/engineer/standard_shotgun/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/chaos/medic
	name = "CHAOS Squad Medic"
	jobtype = "CHAOS Squad Medic"

	belt = /obj/item/storage/belt/lifesaver/chaos/quick
	ears = /obj/item/radio/headset/mainship/chaos
	w_uniform = /obj/item/clothing/under/chaos/medic/vest
	shoes = /obj/item/clothing/shoes/guardsman/chaos/knife
	wear_suit = /obj/item/clothing/suit/modular/chaos/medic
	gloves = /obj/item/clothing/gloves/guardsman/chaos
	mask = /obj/item/clothing/mask/gas
	head = /obj/item/clothing/head/modular/chaos
	glasses = /obj/item/clothing/glasses/hud/health
...
/datum/outfit/quick/chaos/medic/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/chaos/medic/standard_assaultrifle/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/chaos/medic/mpi
	name = "MPI_KM Medic"
	desc = "Keeping your buddies alive and in the fight. Equipped with an MPI_KM assault rifle, medium armor and a good selection of grenades. Packs a large amount of medical supplies, the squad medic is vital to maintaining combat viability. An old weapon that was a common sight during the original Martian rebellion, the MPI's good stopping power, reliability and a healthy dose of nostalgia means it is still seen in use by some among the CHAOS despite its age."

	suit_store = /obj/item/weapon/gun/rifle/mpi_km/black/magharness

/datum/outfit/quick/chaos/medic/mpi/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/chaos/medic/standard_carbine/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/chaos/medic/standard_smg/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/chaos/medic/standard_shotgun/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/chaos/veteran
	name = "CHAOS Squad Veteran"
	jobtype = "CHAOS Squad Veteran"
...
/datum/outfit/quick/chaos/veteran/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/chaos/veteran/standard_assaultrifle
	...
	desc = "Heavily armed and armored CHAOS elite. Equipped with a V-31 assault rifle with integrated 'micro grenade' rail launcher, heavy armor, a large variety of grenades as well as AP ammunition. Excellent performance against heavily armored targets, while the plentiful grenade provide greater tactical flexibility."

	back = /obj/item/storage/backpack/lightpack/chaos
	suit_store = /obj/item/weapon/gun/rifle/chaos/veteran
	belt = /obj/item/storage/belt/guardsman/chaos/chaos_rifle_ap

/datum/outfit/quick/chaos/veteran/standard_assaultrifle/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/explosive/plastique, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/chaos/veteran/standard_smg
	...
	suit_store = /obj/item/weapon/gun/smg/chaos/veteran
	belt = /obj/item/storage/belt/guardsman/chaos/chaos_smg_ap

/datum/outfit/quick/chaos/veteran/standard_smg/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/explosive/plastique, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/weapon/gun/pistol/chaos/standard(H), SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/chaos/ap, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/chaos/ap, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/chaos/ap, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/chaos/veteran/breacher/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/tool/weldingtool/largetank, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/explosive/plastique, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/explosive/plastique, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/chaos/veteran/charger
	...
	desc = "Heavily armed and armored CHAOS elite. Equipped with a volkite charger with motion sensor and gyrostabiliser for better one handed use, heavy armor and a good variety of grenades. Volkite weapons are exceptionally dangerous, especially against poorly armored or tightly grouped opponents. The charger is the CHAOS's premier close/medium range weapon, with good mobility, and can be used (with some difficulty) one handed."

	suit_store = /obj/item/weapon/gun/energy/lasgun/lasrifle/volkite/charger/scout
	belt = /obj/item/storage/belt/guardsman/chaos/volkite

/datum/outfit/quick/chaos/veteran/charger/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/weapon/gun/pistol/chaos/standard(H), SLOT_IN_BACKPACK)
...
/datum/outfit/quick/chaos/veteran/caliver
	...
	desc = "Heavily armed and armored CHAOS elite. Equipped with a volkite caliver, heavy armor and a good variety of grenades. Volkite weapons are exceptionally dangerous, especially against poorly armored or tightly grouped opponents. The caliver provides deadly firepower at all ranges. Approach with caution."

	suit_store = /obj/item/weapon/gun/energy/lasgun/lasrifle/volkite/caliver/standard
	belt = /obj/item/storage/belt/guardsman/chaos/volkite

/datum/outfit/quick/chaos/veteran/caliver/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/weapon/gun/pistol/chaos/standard(H), SLOT_IN_BACKPACK)
...
/datum/outfit/quick/chaos/veteran/caliver_pack/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()

	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_ACCESSORY)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_ACCESSORY)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_ACCESSORY)
	H.equip_to_slot_or_del(new /obj/item/tool/extinguisher/mini, SLOT_IN_ACCESSORY)
	H.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_ACCESSORY)
	...
	H.equip_to_slot_or_del(new /obj/item/weapon/gun/pistol/chaos/standard(H), SLOT_IN_L_POUCH)

/datum/outfit/quick/chaos/veteran/mpi
	name = "MPI_KM Veteran Infantryman"
	desc = "Heavily armed and armored CHAOS elite, with a taste for nostalgia. Equipped with an MPI_KM assault rifle, with under barrel grenade launcher and a large supply of grenades. An old weapon that was a common sight during the original Martian rebellion, the MPI's good stopping power, reliability and a healthy dose of nostalgia means it is still seen in use by some among the CHAOS despite its age."

	suit_store = /obj/item/weapon/gun/rifle/mpi_km/grenadier
	belt = /obj/item/storage/belt/guardsman/chaos/mpi_plum

/datum/outfit/quick/chaos/veteran/mpi/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/chaos/veteran/carbine
	...
	suit_store = /obj/item/weapon/gun/rifle/chaos_carbine/mag_harness
	belt = /obj/item/storage/belt/guardsman/chaos/carbine

/datum/outfit/quick/chaos/veteran/carbine/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/chaos, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/chaos/veteran/culverin/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/chaos/veteran/rocket_man
	...
	back = /obj/item/storage/holster/backholster/rpg/chaos/war_crimes
	l_store = /obj/item/storage/pouch/grenade/chaos

/datum/outfit/quick/chaos/veteran/rocket_man/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/chaos/veteran/blinker
	...
	wear_suit = /obj/item/clothing/suit/modular/chaos/light/shield
	belt = /obj/item/storage/holster/belt/pistol/m4a3/chaos
	suit_store = /obj/item/weapon/energy/sword/chaos
	back = /obj/item/blink_drive

/datum/outfit/quick/chaos/veteran/blinker/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/chaos/squad_leader
	name = "CHAOS Squad Leader"
	jobtype = "CHAOS Squad Leader"
...
/datum/outfit/quick/chaos/squad_leader/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/quick/chaos/squad_leader/standard_assaultrifle/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/explosive/plastique, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/explosive/plastique, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/explosive/plastique, SLOT_IN_BACKPACK)
	...
	H.equip_to_slot_or_del(new /obj/item/binoculars/fire_support/campaign/chaos, SLOT_IN_ACCESSORY)
...
/datum/outfit/quick/chaos/squad_leader/standard_smg/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/weapon/gun/energy/lasgun/lasrifle/volkite/serpenta(H), SLOT_IN_BACKPACK)
	...
	H.equip_to_slot_or_del(new /obj/item/explosive/plastique, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/chaos/ap, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/chaos/incendiary, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/chaos/incendiary, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/chaos/squad_leader/charger/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/weapon/gun/energy/lasgun/lasrifle/volkite/serpenta(H), SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/cell/lasgun/volkite/small, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/tool/extinguisher, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/chaos/squad_leader/caliver/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/weapon/gun/energy/lasgun/lasrifle/volkite/serpenta(H), SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/cell/lasgun/volkite/small, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/tool/extinguisher, SLOT_IN_BACKPACK)
...
/datum/outfit/quick/chaos/squad_leader/mpi
	...
	desc = "For the leader with a taste for nostalgia. Equipped with an MPI_KM assault rifle, with under barrel grenade launcher, Gorgon heavy armor with 'Valkyrie' autodoctor module and a large supply of grenades. An old weapon that was a common sight during the original Martian rebellion, the MPI's good stopping power, reliability and a healthy dose of nostalgia means it is still seen in use by some among the CHAOS despite its age."

	suit_store = /obj/item/weapon/gun/rifle/mpi_km/grenadier
	belt = /obj/item/storage/belt/guardsman/chaos/mpi_plum

/datum/outfit/quick/chaos/squad_leader/mpi/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/weapon/gun/energy/lasgun/lasrifle/volkite/serpenta(H), SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/cell/lasgun/volkite/small, SLOT_IN_BACKPACK)
