...
/datum/emergency_call/icc/print_backstory(mob/living/carbon/human/H)
	to_chat(H, "<B>You are part of the Independent Colonial Confederation Armed Forces (ICCAF), formed by the ICC, a group of former generation ship colonies which have banded together to form economic and military alliances against their much larger neighbor Imperium.</b>")
	...
	to_chat(H, "<B>Eliminate the Imperium personnel onboard, capture the ship. If there are fellow ICC contingents such as the Chaos, then work with them in this goal. Take no prisoners.</B>")
