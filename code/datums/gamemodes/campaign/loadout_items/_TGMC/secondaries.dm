/datum/loadout_item/secondary/gun/guardsman
	jobs_supported = list(SQUAD_GUARDSMAN, SQUAD_CORPSMAN, SQUAD_ENGINEER, SQUAD_LEADER, SQUAD_SMARTGUNNER, FIELD_COMMANDER, STAFF_OFFICER, CAPTAIN)
	item_whitelist = list(
...
/datum/loadout_item/secondary/gun/guardsman/standard_pistol
	name = "P-14"
...
/datum/loadout_item/secondary/gun/guardsman/fc_pistol
...
/datum/loadout_item/secondary/gun/guardsman/so_pistol
	name = "RT-3 pistol"
...
/datum/loadout_item/secondary/gun/guardsman/smart_pistol
	name = "SP-13 pistol"
	desc = "The SP-13 is a IFF-capable sidearm used by the Imperium Guardsman Corps. Has good damage, penetration and magazine capacity. \
...
/datum/loadout_item/secondary/gun/guardsman/standard_heavypistol
	name = "P-23"
...
/datum/loadout_item/secondary/gun/guardsman/mod_four
	name = "MK88 Mod 4"
...
/datum/loadout_item/secondary/gun/guardsman/standard_revolver
	name = "TP-44"
...
/datum/loadout_item/secondary/gun/guardsman/highpower
	name = "Highpower"
...
/datum/loadout_item/secondary/gun/guardsman/laser_pistol
	name = "TE-P"
	desc = "A Imperium standard issue laser pistol abbreviated as TE-P. It has an integrated charge selector for normal, heat and taser settings. \
	...
	ui_icon = "default"
	item_typepath = /obj/item/weapon/gun/energy/lasgun/lasrifle/standard_guardsman_pistol/tactical
	loadout_item_flags = NONE

/datum/loadout_item/secondary/gun/guardsman/standard_machinepistol
	name = "MP-19"
	desc = "Equipped with a motion sensor. The MP-19 is the Imperium Guardsman Corps standard-issue machine pistol. It's known for it's low recoil and scatter when used one handed. \
...
/datum/loadout_item/secondary/gun/guardsman/standard_smg
	name = "SMG-25"
...
/datum/loadout_item/secondary/gun/guardsman/standard_smg/item_checks(datum/outfit_holder/outfit_holder)
	. = ..()
	if(!.)
		return
...
/datum/loadout_item/secondary/gun/guardsman/standard_smg/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
...
/datum/loadout_item/secondary/gun/guardsman/db_shotgun
	name = "SH-34 shotgun"
	...
	ui_icon = "tx34"
	item_typepath = /obj/item/weapon/gun/shotgun/double/guardsman
	item_whitelist = list(/obj/item/storage/holster/belt/ts34 = ITEM_SLOT_BELT)
	req_desc = "Requires a shotgun holster."
	jobs_supported = list(SQUAD_SMARTGUNNER)

/datum/loadout_item/secondary/gun/guardsman/db_shotgun/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
...
/datum/loadout_item/secondary/kit/mirage_nades
	...
	ui_icon = "grenade"
	jobs_supported = list(SQUAD_GUARDSMAN, SQUAD_CORPSMAN, SQUAD_ENGINEER, SQUAD_LEADER, SQUAD_SMARTGUNNER, FIELD_COMMANDER)
...
/datum/loadout_item/secondary/kit/binoculars
	...
	ui_icon = "default"
	purchase_cost = 20
	jobs_supported = list(SQUAD_GUARDSMAN, SQUAD_CORPSMAN, SQUAD_ENGINEER, SQUAD_SMARTGUNNER)
...
/datum/loadout_item/secondary/kit/tgmc_engineer/detpack/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	...
	wearer.equip_to_slot_or_del(new /obj/item/detpack, SLOT_IN_BACKPACK)
	if(istype(wearer.back, /obj/item/storage/backpack/guardsman/tech))
		wearer.equip_to_slot_or_del(new /obj/item/detpack, SLOT_IN_BACKPACK)
	else
