/datum/loadout_item/suit_store/main_gun/guardsman
	jobs_supported = list(SQUAD_GUARDSMAN)

/datum/loadout_item/suit_store/main_gun/guardsman/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
...
/datum/loadout_item/suit_store/main_gun/guardsman/standard_rifle
	name = "AR-12"
...
/datum/loadout_item/suit_store/main_gun/guardsman/standard_rifle/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return ..()
	wearer.equip_to_slot_or_del(new /obj/item/weapon/shield/riot/guardsman/deployable, SLOT_IN_BACKPACK)
	...
	if(!istype(wearer.back, /obj/item/storage/backpack/guardsman/satchel))
...
/datum/loadout_item/suit_store/main_gun/guardsman/standard_rifle/enhanced
	name = "AR-12+"
	desc = "Equipped with red dot sight, extended barrel and underbarrel grenade launcher. The AR-12 is the former main weapon of the TGMC before it was superceded by the AR-18 for general issue. \
	A jack of all trades weapon, effect at close and long range, with good capacity and handling, making it a reliable all-rounder. \
...
/datum/loadout_item/suit_store/main_gun/guardsman/standard_rifle/enhanced/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/tool/extinguisher/mini, SLOT_IN_ACCESSORY)
	return ..()

/datum/loadout_item/suit_store/main_gun/guardsman/laser_rifle
	name = "Laser rifle"
...
/datum/loadout_item/suit_store/main_gun/guardsman/laser_rifle/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
...
/datum/loadout_item/suit_store/main_gun/guardsman/standard_laser_rifle/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
...
/datum/loadout_item/suit_store/main_gun/guardsman/standard_carbine
	name = "AR-18"
...
/datum/loadout_item/suit_store/main_gun/guardsman/standard_carbine/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return ..()
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/packet/p10x24mm, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/guardsman/standard_carbine/enhanced
	name = "AR-18+"
	desc = "Equipped with red dot sight, extended barrel and underbarrel grenade launcher. The AR-18 is the main weapon of the TGMC, offering excellent mobility and impressive close to medium range damage output. \
...
/datum/loadout_item/suit_store/main_gun/guardsman/standard_carbine/enhanced/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/tool/extinguisher/mini, SLOT_IN_ACCESSORY)
	return ..()

/datum/loadout_item/suit_store/main_gun/guardsman/combat_rifle
	name = "AR-11"
...
/datum/loadout_item/suit_store/main_gun/guardsman/combat_rifle/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return ..()
...
/datum/loadout_item/suit_store/main_gun/guardsman/combat_rifle/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/incendiary, SLOT_IN_ACCESSORY)
...
/datum/loadout_item/suit_store/main_gun/guardsman/battle_rifle
	name = "BR-64"
...
/datum/loadout_item/suit_store/main_gun/guardsman/battle_rifle/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return ..()
	wearer.equip_to_slot_or_del(new /obj/item/weapon/shield/riot/guardsman/deployable, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/guardsman/skirmish_rifle
	name = "AR-21"
	desc = "Equipped with red dot sight, extended barrel and underbarrel grenade launcher. \
...
/datum/loadout_item/suit_store/main_gun/guardsman/skirmish_rifle/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return ..()
	wearer.equip_to_slot_or_del(new /obj/item/weapon/shield/riot/guardsman/deployable, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/guardsman/alf
	name = "ALF-51B"
...
/datum/loadout_item/suit_store/main_gun/guardsman/alf/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return ..()
	wearer.equip_to_slot_or_del(new ammo_type, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/guardsman/alf/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade, SLOT_IN_ACCESSORY)
...
/datum/loadout_item/suit_store/main_gun/guardsman/standard_gpmg
	name = "MG-60"
	...
	item_blacklist = list(/obj/item/weapon/gun/energy/lasgun/lasrifle/standard_guardsman_pistol = ITEM_SLOT_SECONDARY)

/datum/loadout_item/suit_store/main_gun/guardsman/standard_gpmg/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return ..()
...
/datum/loadout_item/suit_store/main_gun/guardsman/standard_gpmg/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/storage/box/MRE, SLOT_IN_ACCESSORY)
...
/datum/loadout_item/suit_store/main_gun/guardsman/standard_mmg
	name = "MG-27"
...
/datum/loadout_item/suit_store/main_gun/guardsman/standard_mmg/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return ..()
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/mirage, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/guardsman/standard_mmg/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/storage/box/MRE, SLOT_IN_ACCESSORY)
...
/datum/loadout_item/suit_store/main_gun/guardsman/laser_mg
...
/datum/loadout_item/suit_store/main_gun/guardsman/laser_mg/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return ..()
	wearer.equip_to_slot_or_del(new ammo_type, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/guardsman/laser_mg/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/incendiary, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade, SLOT_IN_ACCESSORY)
...
/datum/loadout_item/suit_store/main_gun/guardsman/flamer
	name = "FL-84"
...
/datum/loadout_item/suit_store/main_gun/guardsman/flamer/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return ..()
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/mirage, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/guardsman/flamer/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/storage/box/MRE, SLOT_IN_ACCESSORY)
...
/datum/loadout_item/suit_store/main_gun/guardsman/shotgun
	name = "SH-35"
...
/datum/loadout_item/suit_store/main_gun/guardsman/shotgun/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return ..()
	wearer.equip_to_slot_or_del(new /obj/item/explosive/plastique, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/guardsman/shotgun/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/storage/box/MRE, SLOT_IN_ACCESSORY)
...
/datum/loadout_item/suit_store/main_gun/guardsman/auto_shotgun
	name = "SH-15"
...
/datum/loadout_item/suit_store/main_gun/guardsman/auto_shotgun/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return ..()
	wearer.equip_to_slot_or_del(new ammo_type, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/guardsman/laser_carbine
	name = "Laser carbine"
...
/datum/loadout_item/suit_store/main_gun/guardsman/laser_carbine/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return ..()
	wearer.equip_to_slot_or_del(new ammo_type, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/guardsman/laser_carbine/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/sticky, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/sticky, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/sticky, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/storage/box/MRE, SLOT_IN_ACCESSORY)
...
/datum/loadout_item/suit_store/main_gun/guardsman/scout_carbine
	name = "AR-18-scout"
...
/datum/loadout_item/suit_store/main_gun/guardsman/scout_carbine/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return ..()
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/packet/p10x24mm, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/guardsman/scout_carbine/enhanced
	name = "AR-18-S+"
	desc = "Equipped with motion detector, extended barrel and underbarrel grenade launcher. The AR-18 is the main weapon of the TGMC, offering excellent mobility and impressive close to medium range damage output. \
	Compared to the AR-12, it suffers from a comparatively smaller magazine size, and is less effective at longer range. \
...
/datum/loadout_item/suit_store/main_gun/guardsman/smg_and_shield
	name = "SMG-25 & shield"
	...
	item_blacklist = list(/obj/item/jetpack_guardsman/heavy = ITEM_SLOT_BACK)

/datum/loadout_item/suit_store/main_gun/guardsman/smg_and_shield/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	wearer.equip_to_slot_or_del(new /obj/item/weapon/shield/riot/guardsman, SLOT_L_HAND)
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new /obj/item/tool/extinguisher/mini, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/guardsman/smg_and_shield/enhanced
...
/datum/loadout_item/suit_store/main_gun/guardsman/standard_smg
	name = "SMG-25"
...
/datum/loadout_item/suit_store/main_gun/guardsman/standard_smg/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new /obj/item/tool/extinguisher/mini, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/guardsman/standard_smg/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
...
/datum/loadout_item/suit_store/main_gun/guardsman/standard_smg/enhanced
	name = "SMG-25+"
	desc = "Equipped with a mag harness, recoil compensator and gyroscopic stabilizer. SMG-25 submachinegun, is a large capacity smg, able to be be used effectively one or two handed. \
...
/datum/loadout_item/suit_store/main_gun/guardsman/scout_rifle
	name = "BR-8"
...
/datum/loadout_item/suit_store/main_gun/guardsman/scout_rifle/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return ..()
	wearer.equip_to_slot_or_del(new ammo_type, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/guardsman/scout_rifle/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	if(istype(wearer.belt, /obj/item/storage/belt))
...
/datum/loadout_item/suit_store/main_gun/guardsman/suppressed_carbine
...
/datum/loadout_item/suit_store/main_gun/guardsman/suppressed_carbine/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return ..()
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/packet/p10x24mm, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/guardsman/suppressed_carbine/enhanced
	name = "AR-18-Suppressed+"
	desc = "Equipped with red dot sight, suppressor and underbarrel grenade launcher. The AR-18 is the main weapon of the TGMC, offering excellent mobility and impressive close to medium range damage output. \
	Compared to the AR-12, it suffers from a comparatively smaller magazine size, and is less effective at longer range. \
...
/datum/loadout_item/suit_store/main_gun/guardsman/suppressed_carbine/enhanced/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/tool/extinguisher/mini, SLOT_IN_ACCESSORY)
	return ..()

/datum/loadout_item/suit_store/main_gun/guardsman/mag_gl
	name = "GL-54"
...
/datum/loadout_item/suit_store/main_gun/guardsman/mag_gl/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return ..()
	wearer.equip_to_slot_or_del(new ammo_type, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/guardsman/mag_gl/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	if(istype(wearer.belt, /obj/item/storage/belt))
		wearer.equip_to_slot_or_del(new ammo_type, SLOT_IN_BELT)
		wearer.equip_to_slot_or_del(new ammo_type, SLOT_IN_BELT)
		wearer.equip_to_slot_or_del(new ammo_type, SLOT_IN_BELT)
...
/datum/loadout_item/suit_store/main_gun/guardsman/plasma_smg
	name = "PL-51"
...
/datum/loadout_item/suit_store/main_gun/guardsman/plasma_smg/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new ammo_type, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/guardsman/plasma_smg/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
...
/datum/loadout_item/suit_store/main_gun/guardsman/plasma_rifle
	name = "PL-38"
...
/datum/loadout_item/suit_store/main_gun/guardsman/plasma_rifle/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new ammo_type, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/guardsman/plasma_rifle/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/flamer_tank/mini, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/flamer_tank/mini, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade, SLOT_IN_ACCESSORY)
...
/datum/loadout_item/suit_store/main_gun/guardsman/plasma_cannon
	name = "PL-96"
...
/datum/loadout_item/suit_store/main_gun/guardsman/plasma_cannon/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new ammo_type, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/guardsman/plasma_cannon/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/bullet/laser, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/bullet/laser, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade, SLOT_IN_ACCESSORY)
...
/datum/loadout_item/suit_store/main_gun/guardsman/minigun
	name = "MG-100"
...
/datum/loadout_item/suit_store/main_gun/guardsman/minigun/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/storage/box/MRE, SLOT_IN_ACCESSORY)
