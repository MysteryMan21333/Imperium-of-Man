...
/datum/loadout_item/r_pocket/standard_first_aid
	...
	desc = "Standard guardsman first-aid pouch. Contains a basic set of medical supplies."
	ui_icon = "medkit"
...
/datum/loadout_item/r_pocket/standard_first_aid/standard_improved
	desc = "Standard guardsman first-aid pouch. Contains a improved set of medical supplies."
...
/datum/loadout_item/r_pocket/guardsman_support_grenades
	name = "Support nades"
	desc = "A pouch carrying a set of six standard support grenades."
	ui_icon = "grenade"
	item_typepath = /obj/item/storage/pouch/grenade/combat_patrol
	jobs_supported = list(SQUAD_GUARDSMAN, SQUAD_CORPSMAN, SQUAD_SMARTGUNNER, SQUAD_LEADER, FIELD_COMMANDER)
	loadout_item_flags = LOADOUT_ITEM_ROUNDSTART_OPTION|LOADOUT_ITEM_DEFAULT_CHOICE

/datum/loadout_item/r_pocket/guardsman_standard_grenades
	name = "Standard nades"
...
/datum/loadout_item/r_pocket/guardsman_construction
...
/datum/loadout_item/r_pocket/guardsman_construction/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
...
/datum/loadout_item/l_pocket/standard_first_aid
	...
	ui_icon = "medkit"
	item_typepath = /obj/item/storage/pouch/firstaid/combat_patrol
	jobs_supported = list(SQUAD_GUARDSMAN, SQUAD_ENGINEER, SQUAD_SMARTGUNNER)
	loadout_item_flags = LOADOUT_ITEM_ROUNDSTART_OPTION|LOADOUT_ITEM_DEFAULT_CHOICE
...
/datum/loadout_item/l_pocket/guardsman_support_grenades
	name = "Support nades"
...
/datum/loadout_item/l_pocket/guardsman_standard_grenades
	name = "Standard nades"
	desc = "A pouch carrying a set of six standard offensive grenades. Contains HE, lasburster and incendiary grenades."
	ui_icon = "grenade"
	item_typepath = /obj/item/storage/pouch/grenade/standard
...
/datum/loadout_item/l_pocket/guardsman_construction
	name = "Construction pouch"
	desc = "A pouch containing an assortment of construction supplies. Allows for the rapid establishment of fortified positions."
	ui_icon = "materials"
	item_typepath = /obj/item/storage/pouch/construction
...
/datum/loadout_item/l_pocket/guardsman_construction/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
...
/datum/loadout_item/l_pocket/guardsman_construction/engineer
...
/datum/loadout_item/l_pocket/guardsman_construction/engineer/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
