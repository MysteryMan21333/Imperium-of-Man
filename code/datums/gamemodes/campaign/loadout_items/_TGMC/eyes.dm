...
/datum/loadout_item/eyes/health_hud
	...
	jobs_supported = list(SQUAD_CORPSMAN, SQUAD_LEADER, FIELD_COMMANDER, STAFF_OFFICER, CAPTAIN, CHAOS_SQUAD_CORPSMAN, CHAOS_SQUAD_LEADER, CHAOS_FIELD_COMMANDER, CHAOS_STAFF_OFFICER, CHAOS_COMMANDER)
	loadout_item_flags = LOADOUT_ITEM_ROUNDSTART_OPTION|LOADOUT_ITEM_DEFAULT_CHOICE
...
/datum/loadout_item/eyes/mesons
	...
	jobs_supported = list(SQUAD_ENGINEER, CHAOS_SQUAD_ENGINEER, CHAOS_SQUAD_VETERAN)
	loadout_item_flags = LOADOUT_ITEM_ROUNDSTART_OPTION|LOADOUT_ITEM_DEFAULT_CHOICE
...
/datum/loadout_item/eyes/welding
	...
	jobs_supported = list(SQUAD_GUARDSMAN, SQUAD_ENGINEER, CHAOS_SQUAD_GUARDSMAN, CHAOS_SQUAD_VETERAN)
