/datum/loadout_item/back/chaos_satchel
	name = "Mining satchel"
	...
	item_typepath = /obj/item/storage/backpack/satchel/chaos
	jobs_supported = list(CHAOS_SQUAD_GUARDSMAN, CHAOS_SQUAD_VETERAN, CHAOS_STAFF_OFFICER, CHAOS_COMMANDER)
	loadout_item_flags = LOADOUT_ITEM_ROUNDSTART_OPTION|LOADOUT_ITEM_DEFAULT_CHOICE

/datum/loadout_item/back/chaos_combat_pack
	...
	purchase_cost = 25
	item_typepath = /obj/item/storage/backpack/lightpack/chaos
	jobs_supported = list(CHAOS_SQUAD_GUARDSMAN, CHAOS_SQUAD_VETERAN)

/datum/loadout_item/back/chaos_combat_pack/free
	purchase_cost = 0
	jobs_supported = list(CHAOS_SQUAD_CORPSMAN, CHAOS_SQUAD_ENGINEER, CHAOS_SQUAD_LEADER, CHAOS_FIELD_COMMANDER)
	loadout_item_flags = LOADOUT_ITEM_ROUNDSTART_OPTION|LOADOUT_ITEM_DEFAULT_CHOICE

/datum/loadout_item/back/chaos_flamer_tank
	name = "Flame tank"
...
/datum/loadout_item/back/chaos_flamer_tank/x_fuel
	name = "X-fuel tank"
...
/datum/loadout_item/back/blinkdrive
	...
	quantity = 2
	item_whitelist = list(
		/obj/item/weapon/energy/sword/chaos = ITEM_SLOT_SUITSTORE,
		/obj/item/weapon/gun/smg/chaos/veteran = ITEM_SLOT_SUITSTORE,
	)

/datum/loadout_item/back/chaos_shotgun
	name = "V-51"
...
/datum/loadout_item/back/chaos_shotgun/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/shotgun/buckshot, SLOT_R_HAND)

/datum/loadout_item/back/chaos_rocket_bag
	name = "RPG bag"
	...
	purchase_cost = 50
	quantity = 2
	item_typepath = /obj/item/storage/holster/backholster/rpg/chaos/war_crimes
	jobs_supported = list(CHAOS_SQUAD_VETERAN)
	item_whitelist = list(/obj/item/clothing/suit/modular/chaos/heavy/mithridatius = ITEM_SLOT_OCLOTHING)

/datum/loadout_item/back/chaos_heat_rocket_bag
	name = "HEAT RPG bag"
	...
	loadout_item_flags = LOADOUT_ITEM_ROUNDSTART_UNLOCKABLE
	quantity = 2
	item_typepath = /obj/item/storage/holster/backholster/rpg/chaos/heat
	jobs_supported = list(CHAOS_SQUAD_VETERAN)
...
/datum/loadout_item/back/boarding_axe
	...
	item_blacklist = list(/obj/item/weapon/twohanded/fireaxe/chaos = ITEM_SLOT_SUITSTORE)
	loadout_item_flags = NONE
