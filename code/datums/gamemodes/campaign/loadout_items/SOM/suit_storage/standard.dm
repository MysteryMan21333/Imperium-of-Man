/datum/loadout_item/suit_store/main_gun/chaos_guardsman
	jobs_supported = list(CHAOS_SQUAD_GUARDSMAN)

/datum/loadout_item/suit_store/main_gun/chaos_guardsman/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/incendiary/chaos, SLOT_IN_ACCESSORY)

/datum/loadout_item/suit_store/main_gun/chaos_guardsman/standard_rifle
	name = "V-31"
	desc = "Equipped with a red dot sight, extended barrel, vertical grip and integrated micro rail launcher. The V-31 is the principal ballistic weapon for the CHAOS. \
	...
	ui_icon = "v31"
	item_typepath = /obj/item/weapon/gun/rifle/chaos/standard
	loadout_item_flags = LOADOUT_ITEM_ROUNDSTART_OPTION|LOADOUT_ITEM_DEFAULT_CHOICE

/datum/loadout_item/suit_store/main_gun/chaos_guardsman/standard_rifle/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return

	wearer.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/chaos_guardsman/standard_rifle/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
...
/datum/loadout_item/suit_store/main_gun/chaos_guardsman/standard_rifle/enhanced
	name = "V-31+"
	desc = "Equipped with a red dot sight, extended barrel, vertical grip and integrated micro rail launcher. The V-31 is the principal ballistic weapon for the CHAOS. \
	It has good mobility and handling and a good rate of fire, but tends to favour closer range fighting compared to many TGMC equivilents. \
	The rail launcher electromagnetically launches a variety of 10 gauge airbursting grenades. Extremely effective when used correctly, their fixed fuse time makes them entirely ineffective at very close or far ranges. \
	...
	secondary_ammo_type = /obj/item/ammo_magazine/rifle/chaos/ap

/datum/loadout_item/suit_store/main_gun/chaos_guardsman/standard_rifle/enhanced/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/tool/extinguisher/mini, SLOT_IN_ACCESSORY)
	return ..()

/datum/loadout_item/suit_store/main_gun/chaos_guardsman/mpi_grenadier
	name = "MPi-KM"
	...
	These weapons were already ancient at that time, and their continued use by the CHAOS speaks more to their cultural legacy than any tactical benefits. \
...
/datum/loadout_item/suit_store/main_gun/chaos_guardsman/mpi_grenadier/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_BACKPACK)
	...
	if(!istype(wearer.back, /obj/item/storage/backpack/satchel))
		wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_BACKPACK)
		wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_BACKPACK)
		wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/incendiary/chaos, SLOT_IN_BACKPACK)
		wearer.equip_to_slot_or_del(new secondary_ammo_type, SLOT_IN_BACKPACK)

/datum/loadout_item/suit_store/main_gun/chaos_guardsman/carbine
	name = "V-34"
	...
	ui_icon = "v34"
	item_typepath = /obj/item/weapon/gun/rifle/chaos_carbine/black/standard

/datum/loadout_item/suit_store/main_gun/chaos_guardsman/carbine/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/chaos_guardsman/smg
	name = "V-21"
	...
	ui_icon = "v21"
	item_typepath = /obj/item/weapon/gun/smg/chaos/scout
	item_whitelist = list(
		/obj/item/clothing/suit/modular/chaos/light/shield = ITEM_SLOT_OCLOTHING,
		/obj/item/clothing/suit/modular/chaos/light/shield_overclocked = ITEM_SLOT_OCLOTHING,
	)

/datum/loadout_item/suit_store/main_gun/chaos_guardsman/smg/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/chaos_guardsman/smg/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/incendiary/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/incendiary/chaos, SLOT_IN_ACCESSORY)
...
/datum/loadout_item/suit_store/main_gun/chaos_guardsman/smg/enhanced
	name = "V-21+"
	desc = "Equipped with a motion sensor, recoil compensator and vertical grip. The V-21 is the principal submachinegun used by the Sons of Mars, with a variable rate of fire. \
	Has outstanding mobility and handling and can be comfortably fired one handed on its lower fire rate mode. \
	When set to its higher rate of fire, it unleashes a staggering torrent of firepower, but is difficult to control even two handed, and quickly loses effectiveness at range. \
	...
	loadout_item_flags = NONE
	secondary_ammo_type = /obj/item/ammo_magazine/smg/chaos/ap

/datum/loadout_item/suit_store/main_gun/chaos_guardsman/smg/enhanced/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/tool/extinguisher/mini, SLOT_IN_ACCESSORY)
	return ..()

/datum/loadout_item/suit_store/main_gun/chaos_guardsman/standard_shotgun
	name = "V-51"
	...
	req_desc = "Requires M-11 scout armor."
	ui_icon = "v51"
	item_typepath = /obj/item/weapon/gun/shotgun/chaos/standard
...
/datum/loadout_item/suit_store/main_gun/chaos_guardsman/standard_shotgun/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
...
/datum/loadout_item/suit_store/main_gun/chaos_guardsman/flamer
	...
	ui_icon = "v62"
	item_typepath = /obj/item/weapon/gun/flamer/chaos/mag_harness
	item_whitelist = list(/obj/item/clothing/suit/modular/chaos/heavy/pyro = ITEM_SLOT_OCLOTHING)

/datum/loadout_item/suit_store/main_gun/chaos_guardsman/flamer/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_BACKPACK)
	...
	wearer.equip_to_slot_or_del(new ammo_type, SLOT_IN_BACKPACK)
	if(!istype(wearer.back, /obj/item/storage/backpack/satchel))
		wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/flamer_tank/large/X/chaos, SLOT_IN_BACKPACK)
		wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/flamer_tank/large/X/chaos, SLOT_IN_BACKPACK)
		wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/flamer_tank/large/X/chaos, SLOT_IN_BACKPACK)

/datum/loadout_item/suit_store/main_gun/chaos_guardsman/flamer/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/tool/extinguisher/mini, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	var/datum/loadout_item/secondary/gun/secondary = holder.equipped_things["[ITEM_SLOT_SECONDARY]"]
	if(istype(secondary) && !isholster(wearer.belt))
...
/datum/loadout_item/suit_store/main_gun/chaos_guardsman/smg_and_shield
	...
	It uses 10x20mm caseless rounds."
	ui_icon = "riot_shield"
	item_typepath = /obj/item/weapon/gun/smg/chaos/one_handed

/datum/loadout_item/suit_store/main_gun/chaos_guardsman/smg_and_shield/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	wearer.equip_to_slot_or_del(new /obj/item/weapon/shield/riot/guardsman/chaos, SLOT_L_HAND)
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/flashbang/stun, SLOT_IN_BACKPACK)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/plastique, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/chaos_guardsman/smg_and_shield/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
...
/datum/loadout_item/suit_store/main_gun/chaos_guardsman/smg_and_shield/enhanced
	name = "V-21+ & riot shield"
	desc = "Equipped with a red dot sight, recoil compensator and vertical grip, along with a S-144 boarding shield, intended for use with M-31 combat armor for boarding actions.. The V-21 is the principal submachinegun used by the Sons of Mars, with a variable rate of fire. \
	Has outstanding mobility and handling and can be comfortably fired one handed on its lower fire rate mode. \
	When set to its higher rate of fire, it unleashes a staggering torrent of firepower, but is difficult to control even two handed, and quickly loses effectiveness at range. \
...
/datum/loadout_item/suit_store/main_gun/chaos_guardsman/machinegunner
	name = "V-41"
	desc = "Equipped with a red dot sight, extended barrel and bipod. The V-41 is a large man portable machine used by the CHAOS, allowing for sustained, accurate suppressive firepower at the cost of mobility and handling. \
	...
	ui_icon = "v41"
	item_typepath = /obj/item/weapon/gun/rifle/chaos_mg/standard

/datum/loadout_item/suit_store/main_gun/chaos_guardsman/machinegunner/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new ammo_type, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/chaos_guardsman/machinegunner/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/smokebomb/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/smokebomb/satrapine, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_ACCESSORY)

/datum/loadout_item/suit_store/main_gun/chaos_guardsman/volkite_charger
	name = "VX-32 charger"
...
/datum/loadout_item/suit_store/main_gun/chaos_guardsman/volkite_charger/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/chaos_guardsman/volkite_charger/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/incendiary/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/incendiary/chaos, SLOT_IN_ACCESSORY)
...
/datum/loadout_item/suit_store/boarding_axe
	name = "Boarding axe"
	desc = "A CHAOS boarding axe, a monstrous two handed weapon that inflicts terrible damage even through heavy armor. \
	...
	ui_icon = "axe"
	item_typepath = /obj/item/weapon/twohanded/fireaxe/chaos
	item_whitelist = list(/obj/item/clothing/suit/modular/chaos/heavy/lorica = ITEM_SLOT_OCLOTHING)
	item_blacklist = list(/obj/item/weapon/twohanded/fireaxe/chaos = ITEM_SLOT_BACK)
	jobs_supported = list(CHAOS_SQUAD_GUARDSMAN)
...
/datum/loadout_item/suit_store/main_gun/chaos_guardsman/suppressed_rifle
	name = "V-31-suppressed"
	desc = "Equipped with a mag harness, suppressor, vertical grip and integrated micro rail launcher. The V-31 is the principal ballistic weapon for the CHAOS. \
	It has good mobility and handling and a good rate of fire, but tends to favour closer range fighting compared to many TGMC equivilents. \
	The rail launcher electromagnetically launches a variety of 10 gauge airbursting grenades. Extremely effective when used correctly, their fixed fuse time makes them entirely ineffective at very close or far ranges. \
	Managing engagement range is thus vital for maximising the effectiveness of this weapon. \
	...
	Uses 10x24mm caseless ammunition and 10 gauge micro grenades."
	ui_icon = "v31"
	item_typepath = /obj/item/weapon/gun/rifle/chaos/suppressed

/datum/loadout_item/suit_store/main_gun/chaos_guardsman/suppressed_rifle/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/chaos_guardsman/suppressed_rifle/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/micro_grenade, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/micro_grenade/dragonbreath, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/micro_grenade/cluster, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/micro_grenade/smoke_burst, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/smokebomb/cloak/chaos, SLOT_IN_ACCESSORY)

/datum/loadout_item/suit_store/main_gun/chaos_guardsman/suppressed_rifle/enhanced
	name = "V-31-suppressed+"
	desc = "Equipped with a mag harness, suppressor, vertical grip and integrated micro rail launcher. The V-31 is the principal ballistic weapon for the CHAOS. \
	It has good mobility and handling and a good rate of fire, but tends to favour closer range fighting compared to many TGMC equivilents. \
	The rail launcher electromagnetically launches a variety of 10 gauge airbursting grenades. Extremely effective when used correctly, their fixed fuse time makes them entirely ineffective at very close or far ranges. \
...
/datum/loadout_item/suit_store/main_gun/chaos_guardsman/suppressed_rifle/enhanced/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/tool/extinguisher/mini, SLOT_IN_ACCESSORY)
	return ..()
