/datum/loadout_item/suit_store/main_gun/chaos_field_commander
	jobs_supported = list(CHAOS_FIELD_COMMANDER)

/datum/loadout_item/suit_store/main_gun/chaos_field_commander/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
...
/datum/loadout_item/suit_store/main_gun/chaos_field_commander/standard_rifle
	name = "V-31"
...
/datum/loadout_item/suit_store/main_gun/chaos_field_commander/standard_rifle/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
...
/datum/loadout_item/suit_store/main_gun/chaos_field_commander/smg
	name = "V-21"
...
/datum/loadout_item/suit_store/main_gun/chaos_field_commander/smg/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new /obj/item/explosive/plastique, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/chaos_field_commander/volkite_charger
	name = "VX-32 charger"
...
/datum/loadout_item/suit_store/main_gun/chaos_field_commander/volkite_charger/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new /obj/item/explosive/plastique, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/chaos_field_commander/volkite_caliver
	name = "VX-33 caliver"
...
/datum/loadout_item/suit_store/main_gun/chaos_field_commander/volkite_caliver/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new /obj/item/explosive/plastique, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/chaos_field_commander/mpi
	name = "MPi-KM"
...
/datum/loadout_item/suit_store/main_gun/chaos_field_commander/mpi/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new /obj/item/explosive/plastique, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/chaos_field_commander/carbine
	name = "V-34"
...
/datum/loadout_item/suit_store/main_gun/chaos_field_commander/carbine/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new /obj/item/explosive/plastique, SLOT_IN_BACKPACK)
