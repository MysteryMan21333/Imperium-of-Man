/datum/loadout_item/suit_store/main_gun/chaos_veteran
	jobs_supported = list(CHAOS_SQUAD_VETERAN)

/datum/loadout_item/suit_store/main_gun/chaos_veteran/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/standard_rifle
	name = "V-31"
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/standard_rifle/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/standard_rifle/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/smg
	name = "V-21"
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/smg/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/smg/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/incendiary/chaos, SLOT_IN_ACCESSORY)
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/breacher
	name = "VX-32B charger"
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/breacher/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/breacher/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_ACCESSORY)
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/volkite_charger
	name = "VX-32 charger"
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/volkite_charger/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new /obj/item/explosive/plastique, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/volkite_charger/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/incendiary/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/flashbang/stun, SLOT_IN_ACCESSORY)
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/volkite_caliver
	name = "VX-33 caliver"
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/volkite_caliver/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new /obj/item/explosive/plastique, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/volkite_caliver/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/incendiary/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/tool/extinguisher/mini, SLOT_IN_ACCESSORY)
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/mpi
	name = "MPi-KM"
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/mpi/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/carbine
	name = "V-34"
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/carbine/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new /obj/item/storage/box/MRE/chaos, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/volkite_caliver_pack
	name = "VX-33P Caliver"
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/volkite_caliver_pack/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/incendiary/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/tool/extinguisher/mini, SLOT_IN_ACCESSORY)
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/volkite_culverin
	name = "VX-42 culverin"
	...
	It has poor mobility and handling and is somewhat inaccurate at range, especially on the move. Despite this, the VX-42 can unleash a blistering amount of firepower, making it one of the most feared weapons in the CHAOS arsenal. \
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/volkite_culverin/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/incendiary/chaos, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/tool/extinguisher/mini, SLOT_IN_ACCESSORY)
...
/datum/loadout_item/suit_store/main_gun/chaos_veteran/radioactive_smg
	name = "V-21R"
	...
	ui_icon = "v21"
	item_typepath = /obj/item/weapon/gun/smg/chaos/support
	item_whitelist = list(/obj/item/clothing/suit/modular/chaos/heavy/mithridatius = ITEM_SLOT_OCLOTHING)
	secondary_ammo_type = /obj/item/ammo_magazine/smg/chaos/rad

/datum/loadout_item/suit_store/main_gun/chaos_veteran/radioactive_smg/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/packet/p10x20mm, SLOT_IN_ACCESSORY)
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/chaos/incendiary, SLOT_IN_ACCESSORY)
	...
	if(istype(wearer.l_store, /obj/item/storage/pouch/magazine))
		...
		wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/chaos/incendiary, SLOT_IN_L_POUCH)
	if(istype(wearer.r_store, /obj/item/storage/pouch/magazine))
		...
		wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/chaos/incendiary, SLOT_IN_R_POUCH)
...
/datum/loadout_item/suit_store/energy_sword
	name = "Energy sword"
	desc = "A CHAOS energy sword. Designed to cut through armored plate. An uncommon primary weapon, typically seen wielded by so called 'blink assault' troops. \
	...
	ui_icon = "machete"
	item_typepath = /obj/item/weapon/energy/sword/chaos
	jobs_supported = list(CHAOS_SQUAD_VETERAN)
