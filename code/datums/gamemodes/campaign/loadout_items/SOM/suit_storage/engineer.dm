/datum/loadout_item/suit_store/main_gun/chaos_engineer
	jobs_supported = list(CHAOS_SQUAD_ENGINEER)

/datum/loadout_item/suit_store/main_gun/chaos_engineer/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
...
/datum/loadout_item/suit_store/main_gun/chaos_engineer/standard_rifle
	name = "V-31"
...
/datum/loadout_item/suit_store/main_gun/chaos_engineer/standard_rifle/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	...
	if(istype(wearer.back, /obj/item/storage/backpack/guardsman/engineerpack/chaos))
		return
...
/datum/loadout_item/suit_store/main_gun/chaos_engineer/standard_rifle/enhanced
	name = "V-31+"
	desc = "Equipped with a red dot sight, extended barrel, vertical grip and integrated micro rail launcher. The V-31 is the principal ballistic weapon for the CHAOS. \
	It has good mobility and handling and a good rate of fire, but tends to favour closer range fighting compared to many TGMC equivilents. \
	The rail launcher electromagnetically launches a variety of 10 gauge airbursting grenades. Extremely effective when used correctly, their fixed fuse time makes them entirely ineffective at very close or far ranges. \
...
/datum/loadout_item/suit_store/main_gun/chaos_engineer/mpi
	name = "MPi-KM"
...
/datum/loadout_item/suit_store/main_gun/chaos_engineer/mpi/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
...
/datum/loadout_item/suit_store/main_gun/chaos_engineer/carbine
	name = "V-34"
...
/datum/loadout_item/suit_store/main_gun/chaos_engineer/carbine/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new ammo_type, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/chaos_engineer/smg
	name = "V-21"
...
/datum/loadout_item/suit_store/main_gun/chaos_engineer/smg/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new ammo_type, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/chaos_engineer/smg/enhanced
	name = "V-21+"
	desc = "Equipped with a mag harness, recoil compensator and vertical grip. The V-21 is the principal submachinegun used by the Sons of Mars, with a variable rate of fire. \
	Has outstanding mobility and handling and can be comfortably fired one handed on its lower fire rate mode. \
	When set to its higher rate of fire, it unleashes a staggering torrent of firepower, but is difficult to control even two handed, and quickly loses effectiveness at range. \
...
/datum/loadout_item/suit_store/main_gun/chaos_engineer/flechette_shotgun
	name = "V-51"
	...
	ui_icon = "v51"
	item_typepath = /obj/item/weapon/gun/shotgun/chaos/support
	ammo_type = /obj/item/ammo_magazine/handful/flechette
	secondary_ammo_type = /obj/item/ammo_magazine/handful/flechette

/datum/loadout_item/suit_store/main_gun/chaos_engineer/flechette_shotgun/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new ammo_type, SLOT_IN_BACKPACK)
...
/datum/loadout_item/suit_store/main_gun/chaos_engineer/volkite_charger
	name = "VX-32 charger"
...
/datum/loadout_item/suit_store/main_gun/chaos_engineer/volkite_charger/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	. = ..()
	if(!isstorageobj(wearer.back))
		return
	wearer.equip_to_slot_or_del(new ammo_type, SLOT_IN_BACKPACK)
