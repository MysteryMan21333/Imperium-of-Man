/datum/loadout_item/secondary/gun/chaos
	jobs_supported = list(CHAOS_SQUAD_GUARDSMAN, CHAOS_SQUAD_CORPSMAN, CHAOS_SQUAD_ENGINEER, CHAOS_SQUAD_LEADER, CHAOS_SQUAD_VETERAN, CHAOS_FIELD_COMMANDER)
	item_whitelist = list(
		/obj/item/storage/holster/belt/pistol/m4a3/chaos = ITEM_SLOT_BELT,
		/obj/item/storage/holster/belt/pistol/m4a3/chaos/fancy = ITEM_SLOT_BELT,
...
/datum/loadout_item/secondary/gun/chaos/standard_pistol
	name = "V-11"
	...
	ui_icon = "v11"
	item_typepath = /obj/item/weapon/gun/pistol/chaos/standard
	loadout_item_flags = LOADOUT_ITEM_ROUNDSTART_OPTION|LOADOUT_ITEM_DEFAULT_CHOICE
	jobs_supported = list(CHAOS_SQUAD_GUARDSMAN, CHAOS_SQUAD_CORPSMAN, CHAOS_SQUAD_ENGINEER, CHAOS_SQUAD_VETERAN)

/datum/loadout_item/secondary/gun/chaos/extended_pistol
	name = "V-11e"
	desc = "The standard sidearm used by the Sons of Mars. A reliable and simple weapon that is often seen on the export market on the outer colonies. \
	Typically chambered in 9mm armor piercing rounds. This one is configures for burstfire, and loaded with extended mags."
	ui_icon = "v11"
	item_typepath = /obj/item/weapon/gun/pistol/chaos/burst
...
/datum/loadout_item/secondary/gun/chaos/highpower
	name = "Highpower"
...
/datum/loadout_item/secondary/gun/chaos/serpenta
	name = "VX-12 Serpenta"
	desc = "The 'serpenta' is a volkite energy pistol typically seen in the hands of CHAOS officers and some NCOs, and is quite dangerous for it's size."
	ui_icon = "vx12"
	item_typepath = /obj/item/weapon/gun/energy/lasgun/lasrifle/volkite/serpenta
	jobs_supported = list(CHAOS_SQUAD_LEADER, CHAOS_STAFF_OFFICER)
	loadout_item_flags = LOADOUT_ITEM_ROUNDSTART_OPTION|LOADOUT_ITEM_DEFAULT_CHOICE

/datum/loadout_item/secondary/gun/chaos/serpenta_custom
...
/datum/loadout_item/secondary/gun/chaos/sawn_off
...
/datum/loadout_item/secondary/gun/chaos/sawn_off/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
...
/datum/loadout_item/secondary/esword
	...
	ui_icon = "machete"
	jobs_supported = list(CHAOS_SQUAD_GUARDSMAN, CHAOS_SQUAD_ENGINEER, CHAOS_SQUAD_VETERAN, CHAOS_SQUAD_LEADER)
...
//kits
/datum/loadout_item/secondary/kit/he_nades/chaos
	jobs_supported = list(CHAOS_SQUAD_GUARDSMAN, CHAOS_SQUAD_CORPSMAN, CHAOS_SQUAD_ENGINEER, CHAOS_SQUAD_LEADER, CHAOS_SQUAD_VETERAN, CHAOS_FIELD_COMMANDER)

/datum/loadout_item/secondary/kit/he_nades/chaos/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_BACKPACK)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_BACKPACK)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/chaos, SLOT_IN_BACKPACK)
	wearer.equip_to_slot_or_del(new /obj/item/reagent_containers/hypospray/autoinjector/combat_advanced, SLOT_IN_BACKPACK)

/datum/loadout_item/secondary/kit/binoculars/chaos
	jobs_supported = list(CHAOS_SQUAD_GUARDSMAN, CHAOS_SQUAD_CORPSMAN, CHAOS_SQUAD_ENGINEER, CHAOS_SQUAD_VETERAN)

/datum/loadout_item/secondary/kit/binoculars/chaos/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/binoculars/fire_support/campaign/chaos, SLOT_IN_BACKPACK)
...
/datum/loadout_item/secondary/kit/chaos_engineer
	jobs_supported = list(CHAOS_SQUAD_ENGINEER)

/datum/loadout_item/secondary/kit/chaos_engineer/sentry
	name = "COPE Sentry"
	desc = "A powerful sentry gun. Throw like a grenade to deploy."
	ui_icon = "sentry"
	loadout_item_flags = LOADOUT_ITEM_ROUNDSTART_OPTION|LOADOUT_ITEM_DEFAULT_CHOICE

/datum/loadout_item/secondary/kit/chaos_engineer/sentry/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
...
/datum/loadout_item/secondary/kit/chaos_engineer/large_mines
	name = "Claymores"
...
/datum/loadout_item/secondary/kit/chaos_engineer/large_mines/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/storage/box/explosive_mines/large, SLOT_IN_BACKPACK)
	wearer.equip_to_slot_or_del(new /obj/item/storage/box/explosive_mines/large, SLOT_IN_BACKPACK)
	wearer.equip_to_slot_or_del(new /obj/item/reagent_containers/hypospray/autoinjector/combat_advanced, SLOT_IN_BACKPACK)

/datum/loadout_item/secondary/kit/chaos_engineer/materials
	name = "Metal/plasteel"
	desc = "A full stack of metal and plasteel. For maximum construction."
	ui_icon = "materials"

/datum/loadout_item/secondary/kit/chaos_engineer/materials/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
...
/datum/loadout_item/secondary/kit/chaos_corpsman
	jobs_supported = list(CHAOS_SQUAD_CORPSMAN)

/datum/loadout_item/secondary/kit/chaos_corpsman/advanced
	name = "Advanced meds"
...
/datum/loadout_item/secondary/kit/chaos_corpsman/advanced/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
