//militia jobs
/datum/job/chaos/mercenary/militia
...
/datum/job/chaos/mercenary/militia/radio_help_message(mob/M)
	. = ..()
...
/datum/job/chaos/mercenary/militia/standard
	outfit = /datum/outfit/job/chaos/militia/standard/uzi
	multiple_outfits = TRUE
	outfits = list(
		/datum/outfit/job/chaos/militia/standard/uzi,
		/datum/outfit/job/chaos/militia/standard/skorpion,
		/datum/outfit/job/chaos/militia/standard/mpi_km,
		/datum/outfit/job/chaos/militia/standard/shotgun,
		/datum/outfit/job/chaos/militia/standard/fanatic,
		/datum/outfit/job/chaos/militia/standard/chaos_smg,
		/datum/outfit/job/chaos/militia/standard/mpi_grenadier,
	)

/datum/outfit/job/chaos/militia/standard
	name = "Militia Standard"
	jobtype = /datum/job/chaos/mercenary/militia/standard
...
/datum/outfit/job/chaos/militia/standard/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/job/chaos/militia/standard/uzi/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/storage/box/m94, SLOT_IN_BACKPACK)
...
/datum/outfit/job/chaos/militia/standard/skorpion/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/job/chaos/militia/standard/mpi_km/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/job/chaos/militia/standard/shotgun/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/job/chaos/militia/standard/fanatic/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/buckshot, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/buckshot, SLOT_IN_BACKPACK)
...
/datum/outfit/job/chaos/militia/standard/chaos_smg/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/job/chaos/militia/standard/mpi_grenadier/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/job/chaos/mercenary/militia/medic
	title = "Militial Medic"
	paygrade = "militia2"
	skills_type = /datum/skills/combat_medic
	outfit = /datum/outfit/job/chaos/militia/medic/uzi
	outfits = list(
		/datum/outfit/job/chaos/militia/medic/uzi,
		/datum/outfit/job/chaos/militia/medic/skorpion,
		/datum/outfit/job/chaos/militia/medic/paladin,
	)

/datum/outfit/job/chaos/militia/medic
	name = "Militia Medic"
	jobtype = /datum/job/chaos/mercenary/militia/medic
...
/datum/outfit/job/chaos/militia/medic/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/explosive/grenade/stick, SLOT_IN_SUIT)
	H.equip_to_slot_or_del(new /obj/item/explosive/grenade/stick, SLOT_IN_SUIT)
...
/datum/outfit/job/chaos/militia/medic/uzi/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/uzi/extended, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/uzi/extended, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/uzi/extended, SLOT_IN_BACKPACK)
...
/datum/outfit/job/chaos/militia/medic/skorpion/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/skorpion, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/skorpion, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/skorpion, SLOT_IN_BACKPACK)
...
/datum/outfit/job/chaos/militia/medic/paladin/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/buckshot, SLOT_IN_BACKPACK)
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/buckshot, SLOT_IN_BACKPACK)
...
/datum/job/chaos/mercenary/militia/leader
	title = "Militia Leader"
	paygrade = "militia3"
	skills_type = /datum/skills/sl
	outfit = /datum/outfit/job/chaos/militia/leader/assault_rifle
	outfits = list(
		/datum/outfit/job/chaos/militia/leader/assault_rifle,
		/datum/outfit/job/chaos/militia/leader/mpi_km,
		/datum/outfit/job/chaos/militia/leader/chaos_rifle,
		/datum/outfit/job/chaos/militia/leader/upp_rifle,
		/datum/outfit/job/chaos/militia/leader/lmg_d,
	)

/datum/outfit/job/chaos/militia/leader
	name = "Militia Leader"
	jobtype = /datum/job/chaos/mercenary/militia/leader
...
/datum/outfit/job/chaos/militia/leader/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/job/chaos/militia/leader/assault_rifle/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/job/chaos/militia/leader/mpi_km/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/job/chaos/militia/leader/chaos_rifle/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/job/chaos/militia/leader/upp_rifle/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/job/chaos/militia/leader/lmg_d/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	. = ..()
...
/datum/outfit/job/tgmc/campaign_robot
	...
	suit_store = /obj/item/weapon/gun/energy/lasgun/lasrifle/standard_guardsman_carbine/gyro
...
/datum/outfit/job/tgmc/campaign_robot/jetpack
	...
	suit_store = /obj/item/weapon/gun/energy/lasgun/lasrifle/standard_guardsman_carbine/mag_harness
