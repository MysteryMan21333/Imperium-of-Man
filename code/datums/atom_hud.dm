...
GLOBAL_LIST_INIT_TYPED(huds, /datum/atom_hud, list(
	...
	DATA_HUD_TYRANID_INFECTION = new /datum/atom_hud/tyranid_infection,
	DATA_HUD_TYRANID_REAGENTS = new /datum/atom_hud/tyranid_reagents,
	DATA_HUD_TYRANID_STATUS = new /datum/atom_hud/tyranid,
	DATA_HUD_SQUAD_IMPERIUM = new /datum/atom_hud/squad,
	DATA_HUD_ORDER = new /datum/atom_hud/order,
	DATA_HUD_MEDICAL_PAIN = new /datum/atom_hud/medical/pain,
	DATA_HUD_TYRANID_TACTICAL = new /datum/atom_hud/tyranid_tactical,
	DATA_HUD_SQUAD_CHAOS = new /datum/atom_hud/squad_chaos,
	DATA_HUD_TYRANID_DEBUFF = new /datum/atom_hud/tyranid_debuff,
	DATA_HUD_TYRANID_HEART = new /datum/atom_hud/tyranid_heart,
	))
