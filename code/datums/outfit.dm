...
/datum/outfit/proc/equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	...
	if(ears)
		if(visualsOnly)
			H.equip_to_slot_or_del(new /obj/item/radio/headset(H), SLOT_EARS, override_nodrop = TRUE) //We don't want guardsman cameras. For now they have the same worn_icon_state as the rest.
		else
