GLOBAL_LIST_INIT(bitfields, list(
	...
	"status_toggle_flags" = list(
		...
		"HIVE_STATUS_SHOW_TYRANID_LIST" = HIVE_STATUS_SHOW_TYRANID_LIST,
	...
	"ghost_hud" = list(
		...
		"GHOST_HUD_TYRANID" = GHOST_HUD_TYRANID,
	...
	"resistance_flags" = list(
		...
		"ON_FIRE" = ON_FIRE,
		"TYRANID_DAMAGEABLE" = TYRANID_DAMAGEABLE,
	...
	"restrained_flags" = list(
		"RESTRAINED_TYRANID_NEST" = RESTRAINED_TYRANID_NEST,
	...
	"tyranid_flags" = list(
		"TYRANID_LEAPING" = TYRANID_LEAPING,
		"TYRANID_LEADER" = TYRANID_LEADER,
		"TYRANID_ZOOMED" = TYRANID_ZOOMED,
		"TYRANID_MOBHUD" = TYRANID_MOBHUD,
		"TYRANID_ROUNY" = TYRANID_ROUNY,
	),
))
