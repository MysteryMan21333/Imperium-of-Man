...
GLOBAL_LIST_INIT(guardsman_selector_cats, list(
		CAT_MOD = 1,
		CAT_ARMMOD = 1,
		CAT_STD = 1,
		CAT_SHO = 1,
...
GLOBAL_LIST_INIT(guardsman_gear_listed_products, list())
...
GLOBAL_LIST_INIT(engineer_gear_listed_products, list(
		...
		/obj/item/weapon/shield/riot/guardsman/deployable = list(CAT_ENGSUP, "TL-182 deployable shield", 3, "engi-construction"),
...
GLOBAL_LIST_INIT(leader_gear_listed_products, list(
		...
		/obj/item/weapon/gun/flamer/big_flamer/guardsmanstandard = list(CAT_LEDSUP, "FL-84 flamethrower", 12, "black"),
		/obj/item/ammo_magazine/flamer_tank/large = list(CAT_LEDSUP, "Flamethrower tank", 4, "black"),
		/obj/item/storage/backpack/guardsman/radiopack = list(CAT_LEDSUP, "Radio Pack", 15, "black"),
...
GLOBAL_LIST_INIT(commander_gear_listed_products, list(
		...
		/obj/item/weapon/gun/flamer/big_flamer/guardsmanstandard = list(CAT_FCSUP, "FL-84 flamethrower", 12, "black"),
		/obj/item/ammo_magazine/flamer_tank/large = list(CAT_FCSUP, "Flamethrower tank", 4, "black"),
		/obj/item/storage/backpack/guardsman/radiopack = list(CAT_FCSUP, "Radio Pack", 15, "black"),
...
GLOBAL_LIST_INIT(job_specific_points_vendor, list(
	SQUAD_GUARDSMAN = GLOB.guardsman_gear_listed_products,
...
GLOBAL_LIST_INIT(guardsman_clothes_listed_products, list(
		...
		/obj/item/storage/backpack/guardsman/satchel = list(CAT_BAK, "Satchel", 0, "orange"),
		...
		/obj/item/storage/belt/guardsman = list(CAT_BEL, "Standard ammo belt", 0, "orange"),
...
GLOBAL_LIST_INIT(engineer_clothes_listed_products, list(
		...
		/obj/effect/vendor_bundle/jaeger_assault = list(CAT_AMR, "Jaeger Assault heavy armor kit", 0, "orange"),
		/obj/effect/vendor_bundle/jaeger_eod = list(CAT_AMR, "Jaeger EOD heavy armor kit", 0, "orange"),
		/obj/item/storage/backpack/guardsman/satchel/tech = list(CAT_BAK, "Satchel", 0, "orange"),
		/obj/item/storage/backpack/guardsman/tech = list(CAT_BAK, "Technician Backpack", 0, "black"),
		/obj/item/storage/holster/blade/machete/full = list(CAT_BAK, "Machete scabbard", 0, "black"),
		/obj/item/storage/backpack/guardsman/engineerpack = list(CAT_BAK, "Welderpack", 0, "black"),
		/obj/item/storage/backpack/guardsman/radiopack = list(CAT_BAK, "Radio Pack", 0, "black"),
...
GLOBAL_LIST_INIT(medic_clothes_listed_products, list(
		...
		/obj/effect/vendor_bundle/robot/medium_armor = list(CAT_AMR, "Combat robot medium armor kit", 0, "black"),
		/obj/effect/vendor_bundle/robot/heavy_armor = list(CAT_AMR, "Combat robot heavy armor kit", 0, "black"),
		/obj/item/storage/backpack/guardsman/corpsman/satchel = list(CAT_BAK, "Satchel", 0, "orange"),
		/obj/item/storage/backpack/guardsman/corpsman = list(CAT_BAK, "Corspman Backpack", 0, "black"),
		/obj/item/armor_module/storage/uniform/brown_vest = list(CAT_WEB, "Tactical brown vest", 0, "orange"),
...
GLOBAL_LIST_INIT(synthetic_clothes_listed_products, list(
		...
		/obj/item/clothing/glasses/meson = list(CAT_GLA, "Optical Meson Scanner", 0, "white"),
		/obj/item/clothing/under/guardsman = list(CAT_STD, "TGMC guardsman uniform", 0, "black"),
		...
		/obj/item/clothing/under/guardsman/officer/engi = list(CAT_STD, "Engineering uniform", 0, "black"),
		/obj/item/clothing/under/guardsman/officer/pilot = list(CAT_STD, "Pilot bodysuit", 0, "black"),
		/obj/item/clothing/under/guardsman/mp = list(CAT_STD, "Military police uniform", 0, "black"),
		/obj/item/clothing/under/guardsman/officer/researcher = list(CAT_STD, "Researcher outfit", 0, "black"),
		...
		/obj/item/storage/backpack/guardsman/corpsman = list(CAT_BAK, "TGMC corpsman backpack", 0, "black"),
		/obj/item/storage/backpack/guardsman/tech = list(CAT_BAK, "TGMC technician backpack", 0, "black"),
		/obj/item/storage/backpack/guardsman/engineerpack = list(CAT_BAK, "TGMC technician welderpack", 0, "black"),
		/obj/item/storage/backpack/guardsman/radiopack = list(CAT_BAK, "Radio Pack", 0, "black"),
		/obj/item/storage/backpack/lightpack = list(CAT_BAK, "Lightweight combat pack", 0, "black"),
		/obj/item/storage/backpack/guardsman/satchel/officer_cloak = list(CAT_BAK, "Officer cloak", 0, "black"),
		/obj/item/storage/backpack/guardsman/satchel/officer_cloak_red = list(CAT_BAK, "Officer cloak, red", 0, "black"),
		...
		/obj/item/clothing/gloves/guardsman = list(CAT_GLO, "Combat gloves", 0, "synth-armor"),
		...
		/obj/item/storage/belt/rig/medical = list(CAT_BEL, "Rig belt", 0, "black"),
		/obj/item/storage/belt/hypospraybelt/full = list(CAT_BEL, "Hypospray belt", 0, "black"),
		/obj/item/clothing/shoes/guardsman = list(CAT_SHO, "Guardsman combat boots", 0, "synth-rcmarmor"),
		...
		/obj/item/clothing/head/modular/style/classic_beret = list(CAT_SHN, "Guardsman beret", 0, "synth-rcmarmstorage"),
...
GLOBAL_LIST_INIT(job_specific_clothes_vendor, list(
	SQUAD_GUARDSMAN = GLOB.guardsman_clothes_listed_products,
...
GLOBAL_LIST_INIT(loadout_role_essential_set, list(
	SQUAD_ENGINEER = list (
		...
		/obj/item/clothing/gloves/guardsman/insulated = 1,
		/obj/item/cell/high = 1,
		/obj/item/lightreplacer = 1,
		/obj/item/circuitboard/apc = 1,
		/obj/item/clothing/under/guardsman/engineer = 1,
	),
	SQUAD_CORPSMAN = list(
		...
		/obj/item/clothing/under/guardsman/corpsman = 1,
	),
