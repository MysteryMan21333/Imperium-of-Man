...
#define GHOST_HUD_TYRANID (1<<3)
#define GHOST_HUD_ORDER (1<<4)

#define TOGGLES_GHOSTHUD_DEFAULT (GHOST_HUD_MED|GHOST_HUD_SQUAD|GHOST_HUD_TYRANID|GHOST_HUD_ORDER)
...
#define SELECTABLE_SQUADS_CHAOS list(\
	"Zulu",\
	"Yankee",\
	"Xray",\
	"Whiskey",\
...
#define HIVE_STATUS_SHOW_TYRANID_LIST (1<<4)
#define HIVE_STATUS_SHOW_STRUCTURES (1<<5)
#define HIVE_STATUS_DEFAULTS (HIVE_STATUS_SHOW_EMPTY | HIVE_STATUS_SHOW_GENERAL | HIVE_STATUS_SHOW_POPULATION | HIVE_STATUS_SHOW_TYRANID_LIST | HIVE_STATUS_SHOW_STRUCTURES)
