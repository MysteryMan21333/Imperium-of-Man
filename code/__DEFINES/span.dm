...
#define span_tyranidannounce(str) ("<span class='tyranidannounce'>" + str + "</span>")
#define span_tyraniddanger(str) ("<span class='tyraniddanger'>" + str + "</span>")
#define span_tyranidhighdanger(str) ("<span class='tyranidhighdanger'>" + str + "</span>")
#define span_tyranidnotice(str) ("<span class='tyranidnotice'>" + str + "</span>")
#define span_tyranidwarning(str) ("<span class='tyranidwarning'>" + str + "</span>")
