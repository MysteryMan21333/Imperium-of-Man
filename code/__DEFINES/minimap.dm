...
#define MINIMAP_FLAG_TYRANID (1<<0)
#define MINIMAP_FLAG_GUARDSMAN (1<<1)
#define MINIMAP_FLAG_GUARDSMAN_CHAOS (1<<2)
#define MINIMAP_FLAG_EXCAVATION_ZONE (1<<3)
#define MINIMAP_FLAG_ALL (1<<4) - 1

GLOBAL_LIST_INIT(faction_to_minimap_flag, list(
	FACTION_TYRANID = MINIMAP_FLAG_TYRANID,
	FACTION_IMPERIUM = MINIMAP_FLAG_GUARDSMAN,
	FACTION_CHAOS = MINIMAP_FLAG_GUARDSMAN_CHAOS,
))
