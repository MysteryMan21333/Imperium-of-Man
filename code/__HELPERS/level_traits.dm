...
#define is_mainship_level(z) SSmapping.level_trait(z, ZTRAIT_GUARDSMAN_MAIN_SHIP)
...
#define is_gameplay_level(z) (SSmapping.level_trait(z, ZTRAIT_GUARDSMAN_MAIN_SHIP) || SSmapping.level_trait(z, ZTRAIT_GROUND))
