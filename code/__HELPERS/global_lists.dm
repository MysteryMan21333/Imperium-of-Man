#define ALLTIPS (SSstrings.get_list_from_file("tips/guardsman") + SSstrings.get_list_from_file("tips/tyranid") + SSstrings.get_list_from_file("tips/meme") + SSstrings.get_list_from_file("tips/meta") + SSstrings.get_list_from_file("tips/HvH"))
