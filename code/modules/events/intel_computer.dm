...
///sets the icon on the map. Toggles it between active and inactive, notifies tyranids and guardsmans of the existence of the computer.
/datum/round_event/intel_computer/proc/activate(obj/machinery/computer/intel_computer/I)
	...
	tyranid_message("We sense a looming threat from [get_area(I)]. We must keep the hosts away from there.")
