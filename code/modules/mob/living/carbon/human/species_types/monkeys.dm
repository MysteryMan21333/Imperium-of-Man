/datum/species/monkey
	name = "Monkey"
	icobase = 'modular_imperium/master_files/icons/mob/human_races/r_monkey.dmi'
...
/datum/species/monkey/farwa
	name = "Farwa"
	icobase = 'modular_imperium/master_files/icons/mob/human_races/r_farwa.dmi'

/datum/species/monkey/naera
	name = "Naera"
	icobase = 'modular_imperium/master_files/icons/mob/human_races/r_naera.dmi'

/datum/species/monkey/stok
	name = "Stok"
	icobase = 'modular_imperium/master_files/icons/mob/human_races/r_stok.dmi'

/datum/species/monkey/yiren
	name = "Yiren"
	icobase = 'modular_imperium/master_files/icons/mob/human_races/r_yiren.dmi'
