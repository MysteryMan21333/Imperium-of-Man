...
/obj/item/paper/tutorial/beginner_rifleman
	...
	<BR>
	Try to spend as much time as possible near other guardsmans - being alone is very dangerous.\
	Your versatility is an immense strength and makes you the ideal battle buddy for virtually any other guardsman.\
	...
	When not in immediate danger, use your flare gun to keep your surroundings lit, as your and your fellow guardsmans' lives may very well depend on it.<BR>
	<BR>
	<b>TIPS</b><BR>
	<BR>
	...
	in exchange for allowing you to shoot through allied guardsmans. (Note that your grenades will NOT go through guardsmans!)\
	...
	Flare any dark area you can see to reduce the risk of a tyranid ambushing you.\
	...
	By toggling it in the top left while wielding it, it becomes impossible for you to drop - or for it to be knocked out of your hand by a tyranid.\
...
/obj/item/paper/tutorial/beginner_machinegunner
	...
	info = {"As a machinegunner, you are the backbone of a guardsman force. While you possess heavy armor reinforced with\
	...
	eliminating threats and keeping the guardsmans in front of you safe.\
	...
	or behind your fellow guardsmans, shooting over them with aim mode to protect them from enemies.\
	...
	Your inaprovaline autoinjector is not to be applied to yourself - rather, it should be applied to an alive guardsman\
	...
	In the top left of your screen are several weapon-specific buttons. The "Take Aim" button toggles aim mode, a feature that slows your rate of fire\
	in exchange for allowing you to shoot through allied guardsmans. The bipod button will deploy your bipod, increasing fire rate and accuracy significantly\
	...
	Your flare gun can be rapidly reloaded by just right-clicking the flare pouch with it in hand.\
	Your flare pouch can be refilled by left clicking on it while holding a flare box.\
	Flare any dark area you can see to reduce the risk of a tyranid ambushing you from the dark.\
	On a similar note, your suit's light can be toggled in the top left - you should almost always keep this on to help your visibility.<BR>
	<BR>
	On your belt is a belt harness. By left clicking on your belt harness with your machine gun, you can attach them.\
	If you drop your machine gun, or have a tyranid make you drop it, your machine gun will automatically return to your armor if it's attached.<BR>
	<BR>
	...
	<BR>
	The more bullets you shoot, the better a guardsman you are. It's actually that simple."}
...
/obj/item/paper/tutorial/beginner_marksman
	...
	Tricordrazine (heals all damage, but slowly), and an inaprovaline injector for helping other guardsmans in critical condition.\
	...
	<BR>
	With your DMR, aim to support other guardsmans from afar using your scope and aim mode.\
	Your range means that many tyranids might not realize you're watching over an area until you're already shooting at them - use this to your advantage.\
	...
	Your inaprovaline autoinjector is not to be applied to yourself - rather, it should be applied to an alive guardsman that is so heavily injured they are unconscious\
	...
	The "Take Aim" button toggles aim mode, a feature that slows your rate of fire in exchange for allowing you to shoot through allied guardsmans.\
	...
	or have a tyranid make you drop it, your DMR will automatically return to your armor if it's attached.<BR>
	<BR>
...
/obj/item/paper/tutorial/beginner_shotgunner
	...
	info = {"As a shotgunner, you are the spearhead of the guardsman force.\
	...
	Your role is to be at the front of any guardsman push, side by side with your fellow guardsmans as you charge into danger. Your shotgun shell rig on your belt,\
	...
	rather, be in front of other guardsmans, clearing away enemies to allow them to safely advance and cover you.<BR>
	<BR>
	<b>TIPS</b><BR>
	<BR>
	BKTT is an acronym that is used to describe the combination of Bicaridine, Kelotane, Tricordizine, and Tramadol used as an all-rounder combat medicine mix\
	...
	that you're requesting an airstrike in the region, also granting them the ability to see and shoot at tyranids in the area.<BR>
	<BR>
	Using the powerful knockback of your shotgun to knock tyranids TOWARDS other guardsmans is a good way to get kills\
	- most tyranids can't deal with that many guardsmans at once!<BR>
	<BR>
	Shotguns don't have access to aimmode, so be careful near other guardsmans so you don't risk shooting them.<BR>
	<BR>
	You have incredibly high per-shot damage. Waiting a little bit to allow a tyranid to get closer before opening fire can lure it\
...
/obj/item/paper/tutorial/beginner_shocktrooper
	...
	Like other frontliners, you aim to lead the push into enemy territory, clearing the path forward and facing tyranids head-on.<BR>
	<BR>
	<b>TIPS</b><BR>
	<BR>
	BKTT is an acronym that is used to describe the combination of Bicaridine, Kelotane, Tricordizine, and Tramadol used as an all-rounder combat medicine mix\
...
/obj/item/paper/tutorial/beginner_hazmat
	...
	info = {"As a HAZMAT, you excel in situations too dangerous for other guardsmans. Your Mimir type armor grants you complete immunity to toxic gas,\
	from acid to neurotoxin. It also provides an increased resistance against acid in general, for dealing with ranged tyranids.\
	...
	<BR>
	Unlike other guardsmans, you have no reason to fear toxic gas - and thanks to your tactical sensor, you pose quite a threat to tyranids while in it.\
	Hide in smoke and use your sensor to fire at tyranids that can't see you back.\
	...
	Green circles are friendly targets (or anyone wearing a guardsman ID), while red circles accompanied with an audible blip are unknown (almost always hostile) targets.\
	...
	However, note that tyranids will often determine a guardsman's position in a smoke cloud by their light, so you should turn OFF your light if hiding in smoke!<BR>
	<BR>
	On your belt is a belt harness. By left-clicking on your belt harness with your AR-11, you can attach them.\
	If you drop your AR, or have a tyranid make you drop it, your AR will automatically return to your armor if it's attached.<BR>
	<BR>
...
/obj/item/paper/tutorial/beginner_cqc
	name = "CQC Tutorial"
	info = {"As a CQC guardsman, you are incredibly mobile, and should be using and abusing your speed to dart in and out of danger.\
	...
	a surprise threat to almost any tyranids. Your belt, body armor, and backpack all contain spare magazines for your AR-18.\
...
/obj/item/paper/tutorial/beginner_chad
	...
	and impressive lethality - just take care to avoid harming your fellow guardsmans.\
	...
	Before you get happy on the trigger, make SURE there aren't going to be guardsmans in the blast radius, unless you want to end up filled with bullet holes\
	(which your Hod accident prevention plating will partially block!) With that warning out of the way, you can kill even the beefiest of tyranids with good aim.<BR>
	<BR>
	<b>TIPS</b><BR>
	<BR>
	BKTT is an acronym that is used to describe the combination of Bicaridine, Kelotane, Tricordizine, and Tramadol used as an all-rounder combat medicine mix\
	...
	(Don't get TOO trigger happy, though - your fellow guardsmans are NOT immune.)<BR>
	<BR>
	Your suit's light can be toggled in the top left - you should almost always keep this on to help your visibility.
	<BR>
...
/obj/item/paper/tutorial/builder
	...
	You are the frontline - without you guardsmans will be exposed to attacks from any and all directions.\
	...
	The optical mesons on your eyewear slot give you the ability to see the shape of rooms behind solid walls, though you can't see anything (including tyranids!)\
	behind those walls.\
	...
	Instead pull back 1 tile and build it there; this prevents tyranids from hiding around the corner behind the walls and smacking your cades freely without repercussion.<BR>
	<BR>
	All metal barricades can be upgraded, the basic upgrade is barbed wire.\
	This damages tyranids when they attack the barricade and prevents them (and guardsmans!) from climbing over the barricade.\
	Press Z with metal sheets in your hand to open up a radial menu where you can select to build barbed wire.\
	You can also build razorwire, which you can deploy to the tile in front of you by using it in-hand. Razorwire can trap charging tyranids momentarily to\
	allow guardsmans to shoot them.\
	...
	Ballistic armor increases the cade's resistance to projectile and melee damage and tyranid charges.\<BR>
	<BR>
	...
	You can remove pills from their packets directly by right-clicking on the packet, even while it's in storage.<BR>
	<BR>
	Through your building expertise, guardsmans can hold various critical locations, ensuring steady progress towards mission completion."}
...
/obj/item/paper/tutorial/flamer
	...
	The optical mesons on your eyewear slot give you the ability to see the shape of rooms behind solid walls, though you can't see anything (including tyranids!)\
	behind those walls.\
	Removing resin walls will help open up the battlefield for your fellow guardsmans, ensuring greater vision and mobility, and, hopefully, a greater number of successful\
	fights against tyranids.\
	<BR>
	<b>TIPS</b><BR>
	<BR>
	...
	enemy mazes and to deny areas of movement without punishing tyranids for trekking through the flames.<BR>
	<BR>
	...
	just be careful about any tyranids lurking in the mazes!<BR>
	<BR>
	...
	backlining tyranids trying to cause you a bad day.<BR>
	<BR>
	BKTT is an acronym that is used to describe the combination of Bicaridine, Kelotane, Tricordizine, and Tramadol used as an all-rounder combat medicine mix\
	for any situation that heals all different types of damage. Make sure not to take more than two of each pill at a time - medicine takes a while to process\
	...
	You can remove pills from their packets directly by right-clicking on the packet, even while it's in storage.<BR>
	<BR>
	By removing resin structures with your flamethrower, you ensure area denial and dominance, flushing tyranids out and providing favorable battle circumstances for your\
	fellow guardsmans."}

/obj/item/paper/tutorial/plasmacutter
	name = "Plasma Cutter Tutorial"
	info = {"Tired of watching guardsmans endlessly pour into a maze or terribly held choke point? This is the class for you then!\
	...
	and if you manage to smack a tyranid you'll get rewarded with draining them of a small amount of plasma and earning a bit of charge for your Plasma Cutter.\
	Use this to destroy mazes and punish tyranidss for trying to attack you by refilling your battery.<BR>
	<BR>
	BKTT is an acronym that is used to describe the combination of Bicaridine, Kelotane, Tricordizine, and Tramadol used as an all-rounder combat medicine mix\
	for any situation that heals all different types of damage. Make sure not to take more than two of each pill at a time - medicine takes a while to process\
	through your system, and too many at once risks a dangerous overdose. Your gauze and ointment are body-part specific, unlike medication, but once you start\
...
/obj/item/paper/tutorial/lifesaver
	...
	info = {"As the lifesaver, you are a MEDIC first and foremost. You should be prioritizing healing guardsmans over trying to fight tyranids yourself.\
	...
	Avoid giving someone more than one pill of a given medicine at a time; many pills overdose at three, and some at two, and some guardsmans might go and take a pill themselves,\
	so one is safest. In your armor storage are an assortment of autoinjectors. Combat injectors should be used on guardsmans in active danger, Quick Clot Plus helps deal\
	...
	Try to remain in a safe location, as tyranids do not obey the Geneva Convention and will in fact deliberately target you and your patients as often as possible.<BR>
	<BR>
	<b>TIPS</b><BR>
	<BR>
	...
	In the top left of your screen are several weapon-specific buttons.\
	The "Take Aim" button toggles aim mode, a feature that slows your rate of fire in exchange for allowing you to shoot through allied guardsmans.<BR>
	<BR>
	...
	<BR>
	Guardsmans will "go cold" after five minutes of being dead, rendering them permanently unrevivable.\
	This timer can be extended via your stasis bag or with CPR, which other guardsmans can perform while you work by left-clicking the corpse on help intent\
	while neither of them are wearing a mask.<BR>
	<BR>
	Accidentally overdose a guardsman? They're full of deadly neurotoxin? Don't panic - use Hypervene.\
	While uncomfortable for the guardsman, this medication (located in your medical belt) will rapidly purge their system.<BR>
	<BR>
...
/obj/item/paper/tutorial/hypobelt
	...
	Your belt is full of hyposprays which instantly apply a dose of medicine when you click a guardsman with them.\
	...
	Your boots and helmet contain food.<BR>
	<BR>
	Your light armor and quick injectors make you adept at rapidly getting guardsmans back into the action.\
	However, take care to avoid danger; tyranids WILL target you, and you will go down fast without proper protection.<BR>
	<BR>
	<b>TIPS</b><BR>
	<BR>
	...
	<BR>
	Guardsmans will "go cold" after five minutes of being dead, rendering them permanently unrevivable.\
	This timer can be extended via your stasis bag or with CPR, which other guardsmans can perform while you work by left-clicking the corpse\
...
/obj/item/paper/tutorial/smartmachinegunner
	...
	info = {"As the smartmachinegunner, you are the very backbone of your squad, and should be behind another guardsman or three at all times.\
	...
	<BR>
	You should NEVER be at the front of a group of guardsmans.\
	Aim to provide covering fire for those who are in front, and let them protect you in turn by, well, being in front of you.\
	Remember that your SG-29 fires through guardsmans, so you don't need to worry about friendly fire.<BR>
	<BR>
	<b>TIPS</b><BR>
	<BR>
	BKTT is an acronym that is used to describe the combination of Bicaridine, Kelotane, Tricordizine, and Tramadol used as an all-rounder combat medicine mix\
	...
	which can be done without an empty hand and with a different magazine still in the gun.<BR>
	<BR>
	STAY BEHIND OTHER GUARDSMANS. I cannot stress this enough. You are a priority target for tyranids due to your ability to provide covering fire from behind other guardsmans.<BR>
	<BR>
	...
	instead waiting until you're back behind fortifications or other guardsmans.<BR>
	<BR>
...
/obj/item/paper/tutorial/smartminigunner
	...
	you can fire ten rounds per second for one hundred straight seconds, providing powerful covering fire for other guardsmans.\
	...
	by applying them to a fractured limb. Your inaprovaline autoinjector is not to be applied to yourself - rather, it should be applied to an alive guardsman that is\
	...
	If you drop your minigun, or have a tyranid make you drop it, your machine gun will automatically return to your armor if it's attached.\
	...
	Because of this, you should exclusively reload when it is completely safe to do so, as other guardsmans are counting on you to protect them.<BR>
	<BR>
