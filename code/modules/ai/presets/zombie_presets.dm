...
/mob/living/carbon/human/species/zombie/ai/stay/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/ai_controller, /datum/ai_behavior/tyranid/zombie/idle, null)
...
/mob/living/carbon/human/species/zombie/ai/patrol/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/ai_controller, /datum/ai_behavior/tyranid/zombie/patrolling , null)

/mob/living/carbon/human/species/zombie/ai/follower/Initialize(mapload, atom_to_escort)
	. = ..()
	AddComponent(/datum/component/ai_controller, /datum/ai_behavior/tyranid/zombie, atom_to_escort)
