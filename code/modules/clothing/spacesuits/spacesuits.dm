...
/obj/item/clothing/head/helmet/space
	name = "Space helmet"
	icon = 'modular_imperium/master_files/icons/obj/clothing/headwear/space_suit_helmets.dmi'
	worn_icon_list = list(slot_head_str = 'modular_imperium/master_files/icons/mob/clothing/headwear/space_suit_helmets.dmi')
...
/obj/item/clothing/suit/space
	...
	icon = 'modular_imperium/master_files/icons/obj/clothing/suits/space_suits.dmi'
	worn_icon_list = list(slot_wear_suit_str = 'modular_imperium/master_files/icons/mob/clothing/suits/space_suits.dmi')
	icon_state = "space"
