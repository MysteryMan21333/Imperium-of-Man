...
/datum/ammo/tyranid/web/on_hit_mob(mob/target_mob, obj/projectile/proj)
	. = ..()
...
/datum/ammo/tyranid/leash_ball/on_hit_turf(turf/target_turf, obj/projectile/proj)
	drop_leashball(target_turf.density ? proj.loc : target_turf)

/datum/ammo/tyranid/leash_ball/on_hit_mob(mob/target_mob, obj/projectile/proj)
	var/turf/target_turf = get_turf(target_mob)
	drop_leashball(target_turf.density ? proj.loc : target_turf, proj.firer)

/datum/ammo/tyranid/leash_ball/on_hit_obj(obj/target_obj, obj/projectile/proj)
...
/datum/ammo/tyranid/leash_ball/do_at_max_range(turf/target_turf, obj/projectile/proj)
	drop_leashball(target_turf.density ? proj.loc : target_turf)

/// This spawns a leash ball and checks if the turf is dense before doing so
/datum/ammo/tyranid/leash_ball/proc/drop_leashball(turf/target_turf)
	new /obj/structure/tyranid/aoe_leash(get_turf(target_turf), hivenumber)
