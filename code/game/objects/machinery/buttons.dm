...
/obj/machinery/button/valhalla/guardsman_button
	name = "Tyranid spawner"

/obj/machinery/button/valhalla/guardsman_button/attack_hand(mob/living/user)
	var/tyranid_wanted = tgui_input_list(user, "What tyranid do you want to spawn?", "Tyranid spawn", GLOB.all_tyranid_types)
	if(!tyranid_wanted)
		return
	QDEL_NULL(linked)
	...
	linked = new tyranid_wanted(get_turf(GLOB.valhalla_button_spawn_landmark[link]))

/obj/machinery/button/valhalla/guardsman_spawner
	name = "Guardsman spawner"

/// Generates a list of jobs datums to spawn on a mob
/obj/machinery/button/valhalla/guardsman_spawner/proc/spawn_humans(mob/living/user)
...
/obj/machinery/button/valhalla/guardsman_spawner/attack_alien(mob/living/carbon/tyranid/tyranid_attacker, damage_amount = tyranid_attacker.tyranid_caste.melee_damage, damage_type = BRUTE, armor_type = MELEE, effects = TRUE, armor_penetration = tyranid_attacker.tyranid_caste.melee_ap, isrightclick = FALSE)
	spawn_humans(tyranid_attacker)

/obj/machinery/button/valhalla/guardsman_spawner/attack_hand(mob/living/user)
	spawn_humans(user)
...
/obj/machinery/button/valhalla/vehicle_button/attack_alien(mob/living/carbon/tyranid/tyranid_attacker, damage_amount = tyranid_attacker.tyranid_caste.melee_damage, damage_type = BRUTE, armor_type = MELEE, effects = TRUE, armor_penetration = tyranid_attacker.tyranid_caste.melee_ap, isrightclick = FALSE)
	spawn_vehicles(tyranid_attacker)
