...
/obj/structure/prop/mainship/toolboxforacause2020
	...
	desc = "A worn, but still shining gold toolbox dedicated to those who \"may be stupid\", who lead the way to victory for Imperium, placing third in the tournament.\nA worn inscription says: <i>\"Manley Jyllian, Nick Johnson, and Clark Ulton\"</i>. You feel robust just looking at it."
	icon = 'modular_imperium/master_files/icons/obj/structures/toolboxtrophy.dmi'
