/obj/item/storage/bible
	...
	icon_state ="bible"
	worn_icon_list = list(
		slot_l_hand_str = 'modular_imperium/master_files/icons/mob/inhands/items/books_left.dmi',
		slot_r_hand_str = 'modular_imperium/master_files/icons/mob/inhands/items/books_right.dmi',
	)
	throw_speed = 1
	throw_range = 5
