...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_CHAOS = FREQ_CHAOS,
	RADIO_CHANNEL_COMMAND_CHAOS = FREQ_COMMAND_CHAOS,
	RADIO_CHANNEL_MEDICAL_CHAOS = FREQ_MEDICAL_CHAOS,
	RADIO_CHANNEL_ENGINEERING_CHAOS = FREQ_ENGINEERING_CHAOS,
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_CHAOS]" = RADIO_CHANNEL_CHAOS,
	"[FREQ_COMMAND_CHAOS]" = RADIO_CHANNEL_COMMAND_CHAOS,
	"[FREQ_MEDICAL_CHAOS]" = RADIO_CHANNEL_MEDICAL_CHAOS,
	"[FREQ_ENGINEERING_CHAOS]" = RADIO_CHANNEL_ENGINEERING_CHAOS,
